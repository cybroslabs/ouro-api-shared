...
const (
	...
	// Bit 4: Gap in data (missing or incomplete data sequence).
	StatusBitsGap StatusBits = 1 << 4
	...
	// Bit 9: Parametrization or firmware changed or erroneously set during the value recording.
	...
	// Bits 26–54: Reserved for future use.
