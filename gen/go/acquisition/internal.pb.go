...
type GetDeviceCommunicationUnitsResponse struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Devices map[string]*JobDevice  `protobuf:"bytes,1,rep,name=devices" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}

func (x *GetDeviceCommunicationUnitsResponse) Reset() {
	*x = GetDeviceCommunicationUnitsResponse{}
	mi := &file_acquisition_internal_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetDeviceCommunicationUnitsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDeviceCommunicationUnitsResponse) ProtoMessage() {}

func (x *GetDeviceCommunicationUnitsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_acquisition_internal_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *GetDeviceCommunicationUnitsResponse) GetDevices() map[string]*JobDevice {
	if x != nil {
...
func (x *GetDeviceCommunicationUnitsResponse) SetDevices(v map[string]*JobDevice) {
	x.xxx_hidden_Devices = v
}

type GetDeviceCommunicationUnitsResponse_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	Devices map[string]*JobDevice
}

func (b0 GetDeviceCommunicationUnitsResponse_builder) Build() *GetDeviceCommunicationUnitsResponse {
	m0 := &GetDeviceCommunicationUnitsResponse{}
	b, x := &b0, m0
	_, _ = b, x
...
var file_acquisition_internal_proto_rawDesc = []byte{
	...
	0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x22, 0x80, 0x02, 0x0a, 0x23, 0x47,
	...
	,
	...
	0x63, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x35, 0x5a,
...
var file_acquisition_internal_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_acquisition_internal_proto_goTypes = []any{
	...
	(*GetDeviceCommunicationUnitsResponse)(nil), // 10: io.clbs.openhes.models.acquisition.GetDeviceCommunicationUnitsResponse
	nil,                          // 11: io.clbs.openhes.models.acquisition.GetDeviceCommunicationUnitsResponse.DevicesEntry
	(*common.FieldValue)(nil),    // 12: io.clbs.openhes.models.common.FieldValue
	(*ConnectionInfo)(nil),       // 13: io.clbs.openhes.models.acquisition.ConnectionInfo
	(*StartJobData)(nil),         // 14: io.clbs.openhes.models.acquisition.StartJobData
	(*JobProgressUpdate)(nil),    // 15: io.clbs.openhes.models.acquisition.JobProgressUpdate
	(*ActionProgressUpdate)(nil), // 16: io.clbs.openhes.models.acquisition.ActionProgressUpdate
	(*JobSpec)(nil),              // 17: io.clbs.openhes.models.acquisition.JobSpec
	(*JobStatus)(nil),            // 18: io.clbs.openhes.models.acquisition.JobStatus
	(*JobDevice)(nil),            // 19: io.clbs.openhes.models.acquisition.JobDevice
}
var file_acquisition_internal_proto_depIdxs = []int32{
	12, // 0: io.clbs.openhes.models.acquisition.SetCacheRequest.value:type_name -> io.clbs.openhes.models.common.FieldValue
	12, // 1: io.clbs.openhes.models.acquisition.GetCacheResponse.value:type_name -> io.clbs.openhes.models.common.FieldValue
	13, // 2: io.clbs.openhes.models.acquisition.StartJobsRequest.connection_info:type_name -> io.clbs.openhes.models.acquisition.ConnectionInfo
	14, // 3: io.clbs.openhes.models.acquisition.StartJobsRequest.jobs:type_name -> io.clbs.openhes.models.acquisition.StartJobData
	15, // 4: io.clbs.openhes.models.acquisition.ProgressUpdate.job:type_name -> io.clbs.openhes.models.acquisition.JobProgressUpdate
	16, // 5: io.clbs.openhes.models.acquisition.ProgressUpdate.action:type_name -> io.clbs.openhes.models.acquisition.ActionProgressUpdate
	17, // 6: io.clbs.openhes.models.acquisition.QueueJobsRequest.spec:type_name -> io.clbs.openhes.models.acquisition.JobSpec
	18, // 7: io.clbs.openhes.models.acquisition.GetJobResponse.status:type_name -> io.clbs.openhes.models.acquisition.JobStatus
	11, // 8: io.clbs.openhes.models.acquisition.GetDeviceCommunicationUnitsResponse.devices:type_name -> io.clbs.openhes.models.acquisition.GetDeviceCommunicationUnitsResponse.DevicesEntry
	19, // 9: io.clbs.openhes.models.acquisition.GetDeviceCommunicationUnitsResponse.DevicesEntry.value:type_name -> io.clbs.openhes.models.acquisition.JobDevice
