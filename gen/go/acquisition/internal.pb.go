...
func (x *GetDeviceCommunicationUnitsResponse) GetDevices() map[string]*ListOfConnectionInfo {
	if x != nil {
...
func (x *GetDeviceCommunicationUnitsResponse) SetDevices(v map[string]*ListOfConnectionInfo) {
...
var file_acquisition_internal_proto_rawDesc = []byte{
	...
	0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x22, 0x8b, 0x02, 0x0a, 0x23, 0x47,
	...
	0x65, 0x73, 0x1a, 0x74, 0x0a, 0x0c, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x45, 0x6e, 0x74,
...
var file_acquisition_internal_proto_goTypes = []any{
	...
	(*ListOfConnectionInfo)(nil), // 19: io.clbs.openhes.models.acquisition.ListOfConnectionInfo
}
var file_acquisition_internal_proto_depIdxs = []int32{
	...
	19, // 9: io.clbs.openhes.models.acquisition.GetDeviceCommunicationUnitsResponse.DevicesEntry.value:type_name -> io.clbs.openhes.models.acquisition.ListOfConnectionInfo
