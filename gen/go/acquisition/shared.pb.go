...
const (
	JobPriority_JOB_PRIORITY_UNSPECIFIED JobPriority = 0 // Unspecified priority (treated as default/medium priority).
	JobPriority_JOB_PRIORITY_0           JobPriority = 1 // Lowest priority - for bulk data collection and non-urgent tasks.
	JobPriority_JOB_PRIORITY_1           JobPriority = 2 // Very low priority.
	JobPriority_JOB_PRIORITY_2           JobPriority = 3 // Low priority.
	JobPriority_JOB_PRIORITY_3           JobPriority = 4 // Below-medium priority.
	JobPriority_JOB_PRIORITY_4           JobPriority = 5 // Medium priority - default for regular data collection.
	JobPriority_JOB_PRIORITY_5           JobPriority = 6 // Above-medium priority.
	JobPriority_JOB_PRIORITY_6           JobPriority = 7 // High priority - for important configuration changes.
	JobPriority_JOB_PRIORITY_7           JobPriority = 8 // Very high priority - for urgent operations.
	JobPriority_JOB_PRIORITY_8           JobPriority = 9 // Highest priority - for critical operations like emergency disconnects.
)
...
var (
	SerialConfigFLowControler_name = map[int32]string{
		0: "FLOW_CONTROL_UNSPECIFIED",
		1: "FLOW_CONTROL_NONE",
		2: "FLOW_CONTROL_HARDWARE",
		3: "FLOW_CONTROL_SOFTWARE",
	}
	SerialConfigFLowControler_value = map[string]int32{
...
func (x SerialConfigFLowControler) Enum() *SerialConfigFLowControler {
	p := new(SerialConfigFLowControler)
	*p = x
	return p
}

func (x SerialConfigFLowControler) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SerialConfigFLowControler) Descriptor() protoreflect.EnumDescriptor {
	return file_acquisition_shared_proto_enumTypes[5].Descriptor()
}

func (SerialConfigFLowControler) Type() protoreflect.EnumType {
	return &file_acquisition_shared_proto_enumTypes[5]
}

func (x SerialConfigFLowControler) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
const (
	...
	ActionType_ACTION_TYPE_FIRMWARE_IMAGE_TRANSFER ActionType = 50 // Start a firmware image transfer.
)
...
var (
	ActionType_name = map[int32]string{
		...
		50: "ACTION_TYPE_FIRMWARE_IMAGE_TRANSFER",
	}
	ActionType_value = map[string]int32{
		...
		"ACTION_TYPE_FIRMWARE_IMAGE_TRANSFER": 50,
	}
)
...
const (
	LogRecordLevel_LOG_RECORD_LEVEL_DEBUG   LogRecordLevel = 0 // Debug log record.
	LogRecordLevel_LOG_RECORD_LEVEL_INFO    LogRecordLevel = 1 // Information log record.
	LogRecordLevel_LOG_RECORD_LEVEL_WARNING LogRecordLevel = 2 // Warning log record.
	LogRecordLevel_LOG_RECORD_LEVEL_ERROR   LogRecordLevel = 3 // Error log record.
	LogRecordLevel_LOG_RECORD_LEVEL_FATAL   LogRecordLevel = 4 // Fatal log record.
)
...
func (x *JobAction) GetImageTransfer() *ActionFirmwareImageTransfer {
	if x != nil {
		if x, ok := x.xxx_hidden_Action.(*jobAction_ImageTransfer); ok {
...
func (x *JobAction) SetImageTransfer(v *ActionFirmwareImageTransfer) {
	if v == nil {
		x.xxx_hidden_Action = nil
		return
	}
	x.xxx_hidden_Action = &jobAction_ImageTransfer{v}
}
...
func (x *JobAction) HasImageTransfer() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Action.(*jobAction_ImageTransfer)
	return ok
}
...
func (x *JobAction) ClearImageTransfer() {
	if _, ok := x.xxx_hidden_Action.(*jobAction_ImageTransfer); ok {
		x.xxx_hidden_Action = nil
	}
}
...
const JobAction_ImageTransfer_case case_JobAction_Action = 18
...
func (x *JobAction) WhichAction() case_JobAction_Action {
	...
	case *jobAction_ImageTransfer:
		return JobAction_ImageTransfer_case
	default:
		return JobAction_Action_not_set_case
	}
}
...
type JobAction_builder struct {
	...
	ImageTransfer        *ActionFirmwareImageTransfer
...
func (b0 JobAction_builder) Build() *JobAction {
	...
	if b.ImageTransfer != nil {
		x.xxx_hidden_Action = &jobAction_ImageTransfer{b.ImageTransfer}
	}
	return m0
}
...
type jobAction_ImageTransfer struct {
	ImageTransfer *ActionFirmwareImageTransfer `protobuf:"bytes,18,opt,name=image_transfer,json=imageTransfer,oneof"` // Defines the ActionFirmwareImageTransfer action.
}
...
func (x *JobActionSet) GetImageTransfer() *ActionFirmwareImageTransfer {
	if x != nil {
		if x, ok := x.xxx_hidden_Action.(*jobActionSet_ImageTransfer); ok {
			return x.ImageTransfer
		}
	}
	return nil
...
func (x *JobActionSet) SetImageTransfer(v *ActionFirmwareImageTransfer) {
	if v == nil {
		x.xxx_hidden_Action = nil
		return
	}
	x.xxx_hidden_Action = &jobActionSet_ImageTransfer{v}
}
...
func (x *JobActionSet) HasImageTransfer() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Action.(*jobActionSet_ImageTransfer)
	return ok
}
...
func (x *JobActionSet) ClearImageTransfer() {
	if _, ok := x.xxx_hidden_Action.(*jobActionSet_ImageTransfer); ok {
		x.xxx_hidden_Action = nil
	}
}
...
const JobActionSet_ImageTransfer_case case_JobActionSet_Action = 18
...
func (x *JobActionSet) WhichAction() case_JobActionSet_Action {
	...
	case *jobActionSet_ImageTransfer:
		return JobActionSet_ImageTransfer_case
	default:
		return JobActionSet_Action_not_set_case
	}
}
...
func (b0 JobActionSet_builder) Build() *JobActionSet {
	...
	if b.ImageTransfer != nil {
		x.xxx_hidden_Action = &jobActionSet_ImageTransfer{b.ImageTransfer}
	}
	return m0
}
...
type jobActionSet_ImageTransfer struct {
	ImageTransfer *ActionFirmwareImageTransfer `protobuf:"bytes,18,opt,name=image_transfer,json=imageTransfer,oneof"` // Defines the ActionFirmwareImageTransfer action.
}
...
func (*jobActionSet_ImageTransfer) isJobActionSet_Action() {}
...
type SerialConfig struct {
	state                  protoimpl.MessageState    `protogen:"opaque.v1"`
	xxx_hidden_BaudRate    int32                     `protobuf:"varint,1,opt,name=baud_rate,json=baudRate"`
	...
	xxx_hidden_FlowControl SerialConfigFLowControler `protobuf:"varint,5,opt,name=flow_control,json=flowControl,enum=io.clbs.openhes.models.acquisition.SerialConfigFLowControler"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
func (x *SerialConfig) GetBaudRate() int32 {
	if x != nil {
...
func (x *SerialConfig) GetFlowControl() SerialConfigFLowControler {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 4) {
			return x.xxx_hidden_FlowControl
		}
	}
	return SerialConfigFLowControler_FLOW_CONTROL_UNSPECIFIED
}

func (x *SerialConfig) SetBaudRate(v int32) {
...
func (x *SerialConfig) SetFlowControl(v SerialConfigFLowControler) {
...
func (x *SerialConfig) HasFlowControl() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 4)
...
func (x *SerialConfig) ClearFlowControl() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 4)
	x.xxx_hidden_FlowControl = SerialConfigFLowControler_FLOW_CONTROL_UNSPECIFIED
}
...
type ConnectionTypeSerialMoxa struct {
	...
	xxx_hidden_SerialConfig *SerialConfig          `protobuf:"bytes,5,opt,name=serial_config,json=serialConfig"`
	XXX_raceDetectHookData  protoimpl.RaceDetectHookData
	XXX_presence            [1]uint32
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
...
func (x *ConnectionTypeSerialMoxa) GetSerialConfig() *SerialConfig {
	if x != nil {
		return x.xxx_hidden_SerialConfig
	}
	return nil
}
...
func (x *ConnectionTypeSerialMoxa) SetSerialConfig(v *SerialConfig) {
	x.xxx_hidden_SerialConfig = v
}
...
func (x *ConnectionTypeSerialMoxa) HasSerialConfig() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_SerialConfig != nil
}
...
func (x *ConnectionTypeSerialMoxa) ClearSerialConfig() {
	x.xxx_hidden_SerialConfig = nil
}
...
func (b0 ConnectionTypeSerialMoxa_builder) Build() *ConnectionTypeSerialMoxa {
	...
	x.xxx_hidden_Timeout = b.Timeout
	x.xxx_hidden_SerialConfig = b.SerialConfig
	return m0
}
...
type ConnectionTypeSerialRfc2217 struct {
	...
	xxx_hidden_Port         uint32                 `protobuf:"varint,2,opt,name=port"`
	xxx_hidden_Timeout      *durationpb.Duration   `protobuf:"bytes,3,opt,name=timeout"`
	xxx_hidden_SerialConfig *SerialConfig          `protobuf:"bytes,4,opt,name=serial_config,json=serialConfig"`
	XXX_raceDetectHookData  protoimpl.RaceDetectHookData
	XXX_presence            [1]uint32
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
...
func (x *ConnectionTypeSerialRfc2217) GetSerialConfig() *SerialConfig {
	if x != nil {
		return x.xxx_hidden_SerialConfig
	}
	return nil
...
func (x *ConnectionTypeSerialRfc2217) SetSerialConfig(v *SerialConfig) {
	x.xxx_hidden_SerialConfig = v
}
...
func (x *ConnectionTypeSerialRfc2217) HasSerialConfig() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_SerialConfig != nil
...
func (x *ConnectionTypeSerialRfc2217) ClearSerialConfig() {
	x.xxx_hidden_SerialConfig = nil
}
...
type ActionProgressUpdate struct {
	...
	xxx_hidden_Data         *ActionProgressData      `protobuf:"bytes,4,opt,name=data"`
...
func (x *ActionProgressUpdate) GetData() *ActionProgressData {
	if x != nil {
...
func (x *ActionProgressUpdate) SetData(v *ActionProgressData) {
	x.xxx_hidden_Data = v
}
...
type ActionProgressData struct {
	state           protoimpl.MessageState    `protogen:"opaque.v1"`
	xxx_hidden_Data isActionProgressData_Data `protobuf_oneof:"data"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *ActionProgressData) Reset() {
	*x = ActionProgressData{}
	mi := &file_acquisition_shared_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActionProgressData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActionProgressData) ProtoMessage() {}

func (x *ActionProgressData) ProtoReflect() protoreflect.Message {
	mi := &file_acquisition_shared_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *ActionProgressData) GetNodata() *emptypb.Empty {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*actionProgressData_Nodata); ok {
			return x.Nodata
		}
	}
	return nil
...
func (x *ActionProgressData) GetRegisters() *RegisterValues {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*actionProgressData_Registers); ok {
			return x.Registers
		}
	}
	return nil
...
func (x *ActionProgressData) GetProfile() []byte {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*actionProgressData_Profile); ok {
			return x.Profile
		}
	}
	return nil
...
func (x *ActionProgressData) GetIrregularProfile() *IrregularProfileValues {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*actionProgressData_IrregularProfile); ok {
...
func (x *ActionProgressData) GetDeviceInfo() *DeviceInfo {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*actionProgressData_DeviceInfo); ok {
			return x.DeviceInfo
		}
	}
	return nil
...
func (x *ActionProgressData) GetEvents() *EventRecords {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*actionProgressData_Events); ok {
			return x.Events
		}
	}
	return nil
...
func (x *ActionProgressData) GetTouTable() *timeofuse.TimeOfUseTableSpec {
	if x != nil {
		if x, ok := x.xxx_hidden_Data.(*actionProgressData_TouTable); ok {
			return x.TouTable
		}
	}
	return nil
...
func (x *ActionProgressData) SetNodata(v *emptypb.Empty) {
	if v == nil {
		x.xxx_hidden_Data = nil
		return
	}
	x.xxx_hidden_Data = &actionProgressData_Nodata{v}
}

func (x *ActionProgressData) SetRegisters(v *RegisterValues) {
	if v == nil {
		x.xxx_hidden_Data = nil
		return
	}
	x.xxx_hidden_Data = &actionProgressData_Registers{v}
}

func (x *ActionProgressData) SetProfile(v []byte) {
	if v == nil {
		v = []byte{}
	}
	x.xxx_hidden_Data = &actionProgressData_Profile{v}
}

func (x *ActionProgressData) SetIrregularProfile(v *IrregularProfileValues) {
	if v == nil {
		x.xxx_hidden_Data = nil
		return
	}
	x.xxx_hidden_Data = &actionProgressData_IrregularProfile{v}
}

func (x *ActionProgressData) SetDeviceInfo(v *DeviceInfo) {
	if v == nil {
		x.xxx_hidden_Data = nil
		return
	}
	x.xxx_hidden_Data = &actionProgressData_DeviceInfo{v}
}

func (x *ActionProgressData) SetEvents(v *EventRecords) {
	if v == nil {
		x.xxx_hidden_Data = nil
		return
	}
	x.xxx_hidden_Data = &actionProgressData_Events{v}
}

func (x *ActionProgressData) SetTouTable(v *timeofuse.TimeOfUseTableSpec) {
	if v == nil {
		x.xxx_hidden_Data = nil
		return
	}
	x.xxx_hidden_Data = &actionProgressData_TouTable{v}
}

func (x *ActionProgressData) HasData() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_Data != nil
...
func (x *ActionProgressData) HasNodata() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Data.(*actionProgressData_Nodata)
	return ok
}

func (x *ActionProgressData) HasRegisters() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Data.(*actionProgressData_Registers)
	return ok
}

func (x *ActionProgressData) HasProfile() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Data.(*actionProgressData_Profile)
	return ok
}

func (x *ActionProgressData) HasIrregularProfile() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Data.(*actionProgressData_IrregularProfile)
	return ok
}

func (x *ActionProgressData) HasDeviceInfo() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Data.(*actionProgressData_DeviceInfo)
	return ok
}

func (x *ActionProgressData) HasEvents() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Data.(*actionProgressData_Events)
	return ok
}

func (x *ActionProgressData) HasTouTable() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Data.(*actionProgressData_TouTable)
	return ok
}

func (x *ActionProgressData) ClearData() {
	x.xxx_hidden_Data = nil
}

func (x *ActionProgressData) ClearNodata() {
	if _, ok := x.xxx_hidden_Data.(*actionProgressData_Nodata); ok {
		x.xxx_hidden_Data = nil
	}
}

func (x *ActionProgressData) ClearRegisters() {
	if _, ok := x.xxx_hidden_Data.(*actionProgressData_Registers); ok {
		x.xxx_hidden_Data = nil
	}
}

func (x *ActionProgressData) ClearProfile() {
	if _, ok := x.xxx_hidden_Data.(*actionProgressData_Profile); ok {
		x.xxx_hidden_Data = nil
	}
}

func (x *ActionProgressData) ClearIrregularProfile() {
	if _, ok := x.xxx_hidden_Data.(*actionProgressData_IrregularProfile); ok {
		x.xxx_hidden_Data = nil
	}
}

func (x *ActionProgressData) ClearDeviceInfo() {
	if _, ok := x.xxx_hidden_Data.(*actionProgressData_DeviceInfo); ok {
		x.xxx_hidden_Data = nil
	}
}

func (x *ActionProgressData) ClearEvents() {
	if _, ok := x.xxx_hidden_Data.(*actionProgressData_Events); ok {
		x.xxx_hidden_Data = nil
	}
}

func (x *ActionProgressData) ClearTouTable() {
	if _, ok := x.xxx_hidden_Data.(*actionProgressData_TouTable); ok {
		x.xxx_hidden_Data = nil
	}
}

const ActionProgressData_Data_not_set_case case_ActionProgressData_Data = 0
const ActionProgressData_Nodata_case case_ActionProgressData_Data = 1
const ActionProgressData_Registers_case case_ActionProgressData_Data = 2
const ActionProgressData_Profile_case case_ActionProgressData_Data = 3
const ActionProgressData_IrregularProfile_case case_ActionProgressData_Data = 4
const ActionProgressData_DeviceInfo_case case_ActionProgressData_Data = 5
const ActionProgressData_Events_case case_ActionProgressData_Data = 6
const ActionProgressData_TouTable_case case_ActionProgressData_Data = 7

func (x *ActionProgressData) WhichData() case_ActionProgressData_Data {
	if x == nil {
		return ActionProgressData_Data_not_set_case
	}
	switch x.xxx_hidden_Data.(type) {
	case *actionProgressData_Nodata:
		return ActionProgressData_Nodata_case
	case *actionProgressData_Registers:
		return ActionProgressData_Registers_case
	case *actionProgressData_Profile:
		return ActionProgressData_Profile_case
	case *actionProgressData_IrregularProfile:
		return ActionProgressData_IrregularProfile_case
	case *actionProgressData_DeviceInfo:
		return ActionProgressData_DeviceInfo_case
	case *actionProgressData_Events:
		return ActionProgressData_Events_case
	case *actionProgressData_TouTable:
		return ActionProgressData_TouTable_case
	default:
		return ActionProgressData_Data_not_set_case
	}
}

type ActionProgressData_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 ActionProgressData_builder) Build() *ActionProgressData {
	m0 := &ActionProgressData{}
	b, x := &b0, m0
	_, _ = b, x
	if b.Nodata != nil {
		x.xxx_hidden_Data = &actionProgressData_Nodata{b.Nodata}
	}
	if b.Registers != nil {
		x.xxx_hidden_Data = &actionProgressData_Registers{b.Registers}
	}
	if b.Profile != nil {
		x.xxx_hidden_Data = &actionProgressData_Profile{b.Profile}
	}
	if b.IrregularProfile != nil {
		x.xxx_hidden_Data = &actionProgressData_IrregularProfile{b.IrregularProfile}
	}
	if b.DeviceInfo != nil {
		x.xxx_hidden_Data = &actionProgressData_DeviceInfo{b.DeviceInfo}
	}
	if b.Events != nil {
		x.xxx_hidden_Data = &actionProgressData_Events{b.Events}
	}
	if b.TouTable != nil {
		x.xxx_hidden_Data = &actionProgressData_TouTable{b.TouTable}
	}
	return m0
}

type case_ActionProgressData_Data protoreflect.FieldNumber

func (x case_ActionProgressData_Data) String() string {
...
type isActionProgressData_Data interface {
	isActionProgressData_Data()
}

type actionProgressData_Nodata struct {
	Nodata *emptypb.Empty `protobuf:"bytes,1,opt,name=nodata,oneof"` // Indicates that no data was returned by the action.
}

type actionProgressData_Registers struct {
	Registers *RegisterValues `protobuf:"bytes,2,opt,name=registers,oneof"` // The set of register values.
}

type actionProgressData_Profile struct {
	Profile []byte `protobuf:"bytes,3,opt,name=profile,oneof"` // The set of profile values. For efficiency, the profile values are binary-encoded, see acquisition/encoding.go.
}

type actionProgressData_IrregularProfile struct {
...
type actionProgressData_DeviceInfo struct {
	DeviceInfo *DeviceInfo `protobuf:"bytes,5,opt,name=device_info,json=deviceInfo,oneof"` // The device information.
}

type actionProgressData_Events struct {
	Events *EventRecords `protobuf:"bytes,6,opt,name=events,oneof"` // The event records.
}

type actionProgressData_TouTable struct {
	TouTable *timeofuse.TimeOfUseTableSpec `protobuf:"bytes,7,opt,name=tou_table,json=touTable,oneof"` // The time-of-use (TOU) table.
}

func (*actionProgressData_Nodata) isActionProgressData_Data() {}

func (*actionProgressData_Registers) isActionProgressData_Data() {}

func (*actionProgressData_Profile) isActionProgressData_Data() {}

func (*actionProgressData_IrregularProfile) isActionProgressData_Data() {}

func (*actionProgressData_DeviceInfo) isActionProgressData_Data() {}

func (*actionProgressData_Events) isActionProgressData_Data() {}

func (*actionProgressData_TouTable) isActionProgressData_Data() {}
...
func (x case_ActionData_Data) String() string {
	md := file_acquisition_shared_proto_msgTypes[23].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
func (x case_MeasuredValue_Kind) String() string {
	md := file_acquisition_shared_proto_msgTypes[35].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
type measuredValue_TimestampTzValue struct {
	TimestampTzValue string `protobuf:"bytes,7,opt,name=timestamp_tz_value,json=timestampTzValue,oneof"` // The timestamp with timezone-typed value, stored as an ISO-8601 string.
}
...
type ConnectionTypeControlledSerial struct {
	...
	xxx_hidden_Config    *SerialConfig                              `protobuf:"bytes,4,opt,name=config"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *ConnectionTypeControlledSerial) GetConfig() *SerialConfig {
	if x != nil {
...
func (x *ConnectionTypeControlledSerial) SetConfig(v *SerialConfig) {
...
func (x *ConnectionTypeControlledSerial) HasConfig() bool {
	if x == nil {
		return false
	}
...
func (x *ConnectionTypeControlledSerial) ClearConfig() {
...
func (x case_ConnectionTypeControlledSerial_Converter) String() string {
	md := file_acquisition_shared_proto_msgTypes[37].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
type ActionFirmwareImageTransfer struct {
	state                      protoimpl.MessageState `protogen:"opaque.v1"`
...
func (x *ActionFirmwareImageTransfer) Reset() {
	*x = ActionFirmwareImageTransfer{}
	mi := &file_acquisition_shared_proto_msgTypes[50]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActionFirmwareImageTransfer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActionFirmwareImageTransfer) ProtoMessage() {}

func (x *ActionFirmwareImageTransfer) ProtoReflect() protoreflect.Message {
	mi := &file_acquisition_shared_proto_msgTypes[50]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *ActionFirmwareImageTransfer) GetFirmwareImageId() string {
	if x != nil {
...
func (x *ActionFirmwareImageTransfer) SetFirmwareImageId(v string) {
	x.xxx_hidden_FirmwareImageId = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 1)
}

func (x *ActionFirmwareImageTransfer) HasFirmwareImageId() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *ActionFirmwareImageTransfer) ClearFirmwareImageId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_FirmwareImageId = nil
}

type ActionFirmwareImageTransfer_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	FirmwareImageId *string
}

func (b0 ActionFirmwareImageTransfer_builder) Build() *ActionFirmwareImageTransfer {
	m0 := &ActionFirmwareImageTransfer{}
	b, x := &b0, m0
	_, _ = b, x
...
type JobProgressStatus struct {
	...
	xxx_hidden_Status       JobStatusCode            `protobuf:"varint,1,opt,name=status,enum=io.clbs.openhes.models.acquisition.JobStatusCode"`
	xxx_hidden_Code         JobErrorCode             `protobuf:"varint,2,opt,name=code,enum=io.clbs.openhes.models.acquisition.JobErrorCode"`
	xxx_hidden_Results      *[]*ActionProgressResult `protobuf:"bytes,3,rep,name=results"`
	xxx_hidden_StartedAt    *timestamppb.Timestamp   `protobuf:"bytes,4,opt,name=started_at,json=startedAt"`
	xxx_hidden_FinishedAt   *timestamppb.Timestamp   `protobuf:"bytes,5,opt,name=finished_at,json=finishedAt"`
	xxx_hidden_AttemptsDone int32                    `protobuf:"varint,6,opt,name=attempts_done,json=attemptsDone"`
	xxx_hidden_DeviceInfo   *DeviceInfo              `protobuf:"bytes,7,opt,name=device_info,json=deviceInfo"`
...
func (x *JobProgressStatus) Reset() {
	*x = JobProgressStatus{}
...
func (x *JobProgressStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JobProgressStatus) ProtoMessage() {}

func (x *JobProgressStatus) ProtoReflect() protoreflect.Message {
	mi := &file_acquisition_shared_proto_msgTypes[53]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *JobProgressStatus) GetStatus() JobStatusCode {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 0) {
			return x.xxx_hidden_Status
		}
...
func (x *JobProgressStatus) GetCode() JobErrorCode {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_Code
		}
...
func (x *JobProgressStatus) GetResults() []*ActionProgressResult {
	if x != nil {
		if x.xxx_hidden_Results != nil {
			return *x.xxx_hidden_Results
		}
...
func (x *JobProgressStatus) GetStartedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.xxx_hidden_StartedAt
	}
	return nil
...
func (x *JobProgressStatus) GetFinishedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.xxx_hidden_FinishedAt
	}
	return nil
...
func (x *JobProgressStatus) GetAttemptsDone() int32 {
	if x != nil {
		return x.xxx_hidden_AttemptsDone
	}
	return 0
...
func (x *JobProgressStatus) GetDeviceInfo() *DeviceInfo {
	if x != nil {
		return x.xxx_hidden_DeviceInfo
	}
	return nil
...
func (x *JobProgressStatus) GetQueueId() int64 {
	if x != nil {
		return x.xxx_hidden_QueueId
	}
	return 0
...
func (x *JobProgressStatus) GetErrorMessage() *common.FormattedMessage {
	if x != nil {
		return x.xxx_hidden_ErrorMessage
	}
	return nil
...
func (x *JobProgressStatus) SetStatus(v JobStatusCode) {
	x.xxx_hidden_Status = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 9)
}

func (x *JobProgressStatus) SetCode(v JobErrorCode) {
	x.xxx_hidden_Code = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 1, 9)
}

func (x *JobProgressStatus) SetResults(v []*ActionProgressResult) {
	x.xxx_hidden_Results = &v
}

func (x *JobProgressStatus) SetStartedAt(v *timestamppb.Timestamp) {
	x.xxx_hidden_StartedAt = v
}

func (x *JobProgressStatus) SetFinishedAt(v *timestamppb.Timestamp) {
	x.xxx_hidden_FinishedAt = v
}

func (x *JobProgressStatus) SetAttemptsDone(v int32) {
	x.xxx_hidden_AttemptsDone = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 5, 9)
}

func (x *JobProgressStatus) SetDeviceInfo(v *DeviceInfo) {
	x.xxx_hidden_DeviceInfo = v
}

func (x *JobProgressStatus) SetQueueId(v int64) {
	x.xxx_hidden_QueueId = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 7, 9)
}

func (x *JobProgressStatus) SetErrorMessage(v *common.FormattedMessage) {
	x.xxx_hidden_ErrorMessage = v
}

func (x *JobProgressStatus) HasStatus() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *JobProgressStatus) HasCode() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 1)
...
func (x *JobProgressStatus) HasStartedAt() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_StartedAt != nil
...
func (x *JobProgressStatus) HasFinishedAt() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_FinishedAt != nil
...
func (x *JobProgressStatus) HasAttemptsDone() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 5)
...
func (x *JobProgressStatus) HasDeviceInfo() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_DeviceInfo != nil
...
func (x *JobProgressStatus) HasQueueId() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 7)
...
func (x *JobProgressStatus) HasErrorMessage() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_ErrorMessage != nil
...
func (x *JobProgressStatus) ClearStatus() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_Status = JobStatusCode_JOB_STATUS_UNSPECIFIED
}

func (x *JobProgressStatus) ClearCode() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_Code = JobErrorCode_JOB_ERROR_CODE_UNSPECIFIED
}

func (x *JobProgressStatus) ClearStartedAt() {
	x.xxx_hidden_StartedAt = nil
}

func (x *JobProgressStatus) ClearFinishedAt() {
	x.xxx_hidden_FinishedAt = nil
}

func (x *JobProgressStatus) ClearAttemptsDone() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 5)
	x.xxx_hidden_AttemptsDone = 0
}

func (x *JobProgressStatus) ClearDeviceInfo() {
	x.xxx_hidden_DeviceInfo = nil
}

func (x *JobProgressStatus) ClearQueueId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 7)
	x.xxx_hidden_QueueId = 0
}

func (x *JobProgressStatus) ClearErrorMessage() {
	x.xxx_hidden_ErrorMessage = nil
}

type JobProgressStatus_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	Status       *JobStatusCode
	Code         *JobErrorCode
	Results      []*ActionProgressResult
	StartedAt    *timestamppb.Timestamp
	FinishedAt   *timestamppb.Timestamp
	AttemptsDone *int32
	DeviceInfo   *DeviceInfo
...
func (b0 JobProgressStatus_builder) Build() *JobProgressStatus {
	m0 := &JobProgressStatus{}
	b, x := &b0, m0
	_, _ = b, x
	if b.Status != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 0, 9)
...
type ActionProgressResult struct {
	state                   protoimpl.MessageState   `protogen:"opaque.v1"`
	xxx_hidden_ActionId     *string                  `protobuf:"bytes,1,opt,name=action_id,json=actionId"`
	xxx_hidden_Status       ActionResultCode         `protobuf:"varint,2,opt,name=status,enum=io.clbs.openhes.models.acquisition.ActionResultCode"`
...
func (x *ActionProgressResult) Reset() {
	*x = ActionProgressResult{}
	mi := &file_acquisition_shared_proto_msgTypes[66]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActionProgressResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActionProgressResult) ProtoMessage() {}

func (x *ActionProgressResult) ProtoReflect() protoreflect.Message {
	mi := &file_acquisition_shared_proto_msgTypes[66]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *ActionProgressResult) GetActionId() string {
	if x != nil {
		if x.xxx_hidden_ActionId != nil {
			return *x.xxx_hidden_ActionId
		}
...
func (x *ActionProgressResult) GetStatus() ActionResultCode {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 1) {
			return x.xxx_hidden_Status
		}
...
func (x *ActionProgressResult) GetData() *ActionProgressData {
	if x != nil {
		return x.xxx_hidden_Data
	}
	return nil
...
func (x *ActionProgressResult) HasActionId() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *ActionProgressResult) HasStatus() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 1)
...
func (x *ActionProgressResult) HasData() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_Data != nil
...
func (x *ActionProgressResult) ClearActionId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_ActionId = nil
}

func (x *ActionProgressResult) ClearStatus() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_Status = ActionResultCode_ERROR_CODE_ACTION_UNSPECIFIED
}

func (x *ActionProgressResult) ClearData() {
	x.xxx_hidden_Data = nil
}
...
type ActionProgressResult_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 ActionProgressResult_builder) Build() *ActionProgressResult {
	m0 := &ActionProgressResult{}
	b, x := &b0, m0
	_, _ = b, x
	if b.ActionId != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 0, 5)
...
type DeviceSpec struct {
	...
	xxx_hidden_Timezone              *string                                      `protobuf:"bytes,4,opt,name=timezone"`
	xxx_hidden_DefaultLinkAttributes *[]*DefaultDeviceCommunicationUnitAttributes `protobuf:"bytes,5,rep,name=default_link_attributes,json=defaultLinkAttributes"`
	XXX_raceDetectHookData           protoimpl.RaceDetectHookData
	XXX_presence                     [1]uint32
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
...
func (x *DeviceSpec) GetDefaultLinkAttributes() []*DefaultDeviceCommunicationUnitAttributes {
	if x != nil {
		if x.xxx_hidden_DefaultLinkAttributes != nil {
			return *x.xxx_hidden_DefaultLinkAttributes
		}
	}
	return nil
}
...
func (x *DeviceSpec) SetDefaultLinkAttributes(v []*DefaultDeviceCommunicationUnitAttributes) {
	x.xxx_hidden_DefaultLinkAttributes = &v
}
...
func (b0 DeviceSpec_builder) Build() *DeviceSpec {
	...
	x.xxx_hidden_DefaultLinkAttributes = &b.DefaultLinkAttributes
	return m0
}
...
func (x *DefaultDeviceCommunicationUnitAttributes) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DefaultDeviceCommunicationUnitAttributes) GetAppProtocol() ApplicationProtocol {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 0) {
			return x.xxx_hidden_AppProtocol
		}
...
func (x *DefaultDeviceCommunicationUnitAttributes) SetAppProtocol(v ApplicationProtocol) {
	x.xxx_hidden_AppProtocol = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 2)
}

func (x *DefaultDeviceCommunicationUnitAttributes) SetAttributes(v map[string]*common.FieldValue) {
	x.xxx_hidden_Attributes = v
}

func (x *DefaultDeviceCommunicationUnitAttributes) HasAppProtocol() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (b0 DefaultDeviceCommunicationUnitAttributes_builder) Build() *DefaultDeviceCommunicationUnitAttributes {
	m0 := &DefaultDeviceCommunicationUnitAttributes{}
	b, x := &b0, m0
	_, _ = b, x
	if b.AppProtocol != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 0, 2)
...
type JobDoneNotification struct {
	...
	xxx_hidden_Status *JobProgressStatus     `protobuf:"bytes,2,opt,name=status"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *JobDoneNotification) GetStatus() *JobProgressStatus {
	if x != nil {
		return x.xxx_hidden_Status
	}
	return nil
...
func (x *JobDoneNotification) SetStatus(v *JobProgressStatus) {
	x.xxx_hidden_Status = v
}
...
const file_acquisition_shared_proto_rawDesc = "" +
	...
	"\x10read_path_policy\x18\a \x01(\x0e22.io.clbs.openhes.models.acquisition.ReadPathPolicyR\x0ereadPathPolicy\"\xfd\v\n" +
	"\tJobAction\x12\x1b\n" +
	...
	"setLimiter\x12p\n" +
	"\x14reset_billing_period\x18\x11 \x01(\v2<.io.clbs.openhes.models.acquisition.ActionResetBillingPeriodH\x00R\x12resetBillingPeriod\x12h\n" +
	"\x0eimage_transfer\x18\x12 \x01(\v2?.io.clbs.openhes.models.acquisition.ActionFirmwareImageTransferH\x00R\rimageTransfer\x1ah\n" +
	...
	"setLimiter\x12p\n" +
	"\x14reset_billing_period\x18\x11 \x01(\v2<.io.clbs.openhes.models.acquisition.ActionResetBillingPeriodH\x00R\x12resetBillingPeriod\x12h\n" +
	"\x0eimage_transfer\x18\x12 \x01(\v2?.io.clbs.openhes.models.acquisition.ActionFirmwareImageTransferH\x00R\rimageTransferB\b\n" +
	"\x06action\"u\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12?\n" +
	"\x05value\x18\x02 \x01(\v2).io.clbs.openhes.models.common.FieldValueR\x05value:\x028\x01\"\x85\x04\n" +
	"\tModemInfo\x12\x19\n" +
	...
	" \x01(\v2B.io.clbs.openhes.models.acquisition.ConnectionTypeControlledSerialH\x00R\fserialOverIpB\x12\n" +
	"\x10modem_connection\"\x8b\x03\n" +
	"\fSerialConfig\x12\x1b\n" +
	"\tbaud_rate\x18\x01 \x01(\x05R\bbaudRate\x12N\n" +
	...
	"\tstop_bits\x18\x04 \x01(\x0e28.io.clbs.openhes.models.acquisition.SerialConfigStopBitsR\bstopBits\x12`\n" +
	"\fflow_control\x18\x05 \x01(\x0e2=.io.clbs.openhes.models.acquisition.SerialConfigFLowControlerR\vflowControl\"\x9a\x05\n" +
	...
	"\atimeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x12U\n" +
	"\rserial_config\x18\x05 \x01(\v20.io.clbs.openhes.models.acquisition.SerialConfigR\fserialConfig\"\xd1\x01\n" +
	"\x1bConnectionTypeSerialRfc2217\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x12U\n" +
	"\rserial_config\x18\x04 \x01(\v20.io.clbs.openhes.models.acquisition.SerialConfigR\fserialConfig\"\xc2\x01\n" +
	...
	"\x19uknown_device_descriptors\x18\x06 \x03(\v2..io.clbs.openhes.models.common.FieldDescriptorR\x17uknownDeviceDescriptors\"\xb6\x02\n" +
	"\x14ActionProgressUpdate\x12\x15\n" +
	"\x06job_id\x18\x01 \x01(\tR\x05jobId\x12\x1b\n" +
	"\taction_id\x18\x02 \x01(\tR\bactionId\x12H\n" +
	"\x04code\x18\x03 \x01(\x0e24.io.clbs.openhes.models.acquisition.ActionResultCodeR\x04code\x12J\n" +
	"\x04data\x18\x04 \x01(\v26.io.clbs.openhes.models.acquisition.ActionProgressDataR\x04data\x12T\n" +
	...
	"\rerror_message\x18\x04 \x01(\v2/.io.clbs.openhes.models.common.FormattedMessageR\ferrorMessage\"\xa9\x04\n" +
	"\x12ActionProgressData\x120\n" +
	"\x06nodata\x18\x01 \x01(\v2\x16.google.protobuf.EmptyH\x00R\x06nodata\x12R\n" +
	"\tregisters\x18\x02 \x01(\v22.io.clbs.openhes.models.acquisition.RegisterValuesH\x00R\tregisters\x12\x1a\n" +
	"\aprofile\x18\x03 \x01(\fH\x00R\aprofile\x12i\n" +
	...
	"\arfc2217\x18\x03 \x01(\v2?.io.clbs.openhes.models.acquisition.ConnectionTypeSerialRfc2217H\x00R\arfc2217\x12H\n" +
	"\x06config\x18\x04 \x01(\v20.io.clbs.openhes.models.acquisition.SerialConfigR\x06configB\v\n" +
	"\tconverter\"^\n" +
	...
	"\x18ActionResetBillingPeriod\"I\n" +
	"\x1bActionFirmwareImageTransfer\x12*\n" +
	...
	"\rerror_message\x18\t \x01(\v2/.io.clbs.openhes.models.common.FormattedMessageR\ferrorMessage\"\xd7\x04\n" +
	"\x11JobProgressStatus\x12I\n" +
	"\x06status\x18\x01 \x01(\x0e21.io.clbs.openhes.models.acquisition.JobStatusCodeR\x06status\x12D\n" +
	"\x04code\x18\x02 \x01(\x0e20.io.clbs.openhes.models.acquisition.JobErrorCodeR\x04code\x12R\n" +
	"\aresults\x18\x03 \x03(\v28.io.clbs.openhes.models.acquisition.ActionProgressResultR\aresults\x129\n" +
	"\n" +
	"started_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tstartedAt\x12;\n" +
	"\vfinished_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"finishedAt\x12#\n" +
	...
	"\btimezone\x18\x04 \x01(\tR\btimezone\x12\x84\x01\n" +
	"\x17default_link_attributes\x18\x05 \x03(\v2L.io.clbs.openhes.models.acquisition.DefaultDeviceCommunicationUnitAttributesR\x15defaultLinkAttributes\"s\n" +
	"\fDeviceStatus\x12B\n" +
	...
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12?\n" +
	"\x05value\x18\x02 \x01(\v2).io.clbs.openhes.models.common.FieldValueR\x05value:\x028\x01\"\xee\x02\n" +
	"(DefaultDeviceCommunicationUnitAttributes\x12Z\n" +
	"\fapp_protocol\x18\x01 \x01(\x0e27.io.clbs.openhes.models.acquisition.ApplicationProtocolR\vappProtocol\x12|\n" +
	"\n" +
	"attributes\x18\x02 \x03(\v2\\.io.clbs.openhes.models.acquisition.DefaultDeviceCommunicationUnitAttributes.AttributesEntryR\n" +
	"attributes\x1ah\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12?\n" +
	...
	"\rvariable_name\x18\x04 \x03(\tR\fvariableName\"\xa5\x01\n" +
	"\x13JobDoneNotification\x12?\n" +
	"\x04spec\x18\x01 \x01(\v2+.io.clbs.openhes.models.acquisition.JobSpecR\x04spec\x12M\n" +
	"\x06status\x18\x02 \x01(\v25.io.clbs.openhes.models.acquisition.JobProgressStatusR\x06status\"G\n" +
	"\n" +
	"DriverInfo\x12\x1f\n" +
	"\vdriver_type\x18\x01 \x01(\tR\n" +
	"driverType\x12\x18\n" +
	...
	" ACTION_TYPE_RESET_BILLING_PERIOD\x10(\x12'\n" +
	"#ACTION_TYPE_FIRMWARE_IMAGE_TRANSFER\x102*\xae\x01\n" +
...
var file_acquisition_shared_proto_msgTypes = make([]protoimpl.MessageInfo, 95)
var file_acquisition_shared_proto_goTypes = []any{
	...
	(SerialConfigFLowControler)(0),                   // 5: io.clbs.openhes.models.acquisition.SerialConfigFLowControler
	...
	(*ActionProgressData)(nil),                       // 39: io.clbs.openhes.models.acquisition.ActionProgressData
	(*ActionData)(nil),                               // 40: io.clbs.openhes.models.acquisition.ActionData
	(*EventRecords)(nil),                             // 41: io.clbs.openhes.models.acquisition.EventRecords
	(*EventRecord)(nil),                              // 42: io.clbs.openhes.models.acquisition.EventRecord
	(*DeviceEventRecord)(nil),                        // 43: io.clbs.openhes.models.acquisition.DeviceEventRecord
	(*DeviceEvents)(nil),                             // 44: io.clbs.openhes.models.acquisition.DeviceEvents
	(*DeviceInfo)(nil),                               // 45: io.clbs.openhes.models.acquisition.DeviceInfo
	(*ProfileValues)(nil),                            // 46: io.clbs.openhes.models.acquisition.ProfileValues
	(*IrregularProfileValues)(nil),                   // 47: io.clbs.openhes.models.acquisition.IrregularProfileValues
	(*IrregularValue)(nil),                           // 48: io.clbs.openhes.models.acquisition.IrregularValue
	(*ProfileBlock)(nil),                             // 49: io.clbs.openhes.models.acquisition.ProfileBlock
	(*RegisterValues)(nil),                           // 50: io.clbs.openhes.models.acquisition.RegisterValues
	(*RegisterValue)(nil),                            // 51: io.clbs.openhes.models.acquisition.RegisterValue
	(*MeasuredValue)(nil),                            // 52: io.clbs.openhes.models.acquisition.MeasuredValue
	(*JobActionAttributes)(nil),                      // 53: io.clbs.openhes.models.acquisition.JobActionAttributes
	(*ConnectionTypeControlledSerial)(nil),           // 54: io.clbs.openhes.models.acquisition.ConnectionTypeControlledSerial
	(*ActionGetRegister)(nil),                        // 55: io.clbs.openhes.models.acquisition.ActionGetRegister
	(*ActionGetPeriodicalProfile)(nil),               // 56: io.clbs.openhes.models.acquisition.ActionGetPeriodicalProfile
	(*ActionGetIrregularProfile)(nil),                // 57: io.clbs.openhes.models.acquisition.ActionGetIrregularProfile
	(*ActionGetEvents)(nil),                          // 58: io.clbs.openhes.models.acquisition.ActionGetEvents
	(*ActionGetDeviceInfo)(nil),                      // 59: io.clbs.openhes.models.acquisition.ActionGetDeviceInfo
	(*ActionSyncClock)(nil),                          // 60: io.clbs.openhes.models.acquisition.ActionSyncClock
	(*ActionSetRelayState)(nil),                      // 61: io.clbs.openhes.models.acquisition.ActionSetRelayState
	(*ActionSetDisconnectorState)(nil),               // 62: io.clbs.openhes.models.acquisition.ActionSetDisconnectorState
	(*ActionGetTou)(nil),                             // 63: io.clbs.openhes.models.acquisition.ActionGetTou
	...
	(*ActionFirmwareImageTransfer)(nil),              // 67: io.clbs.openhes.models.acquisition.ActionFirmwareImageTransfer
	...
	(*StartJobData)(nil),                             // 71: io.clbs.openhes.models.acquisition.StartJobData
	(*CancelJobRequest)(nil),                         // 72: io.clbs.openhes.models.acquisition.CancelJobRequest
	(*DeviceConfigurationRegisterSpec)(nil),          // 73: io.clbs.openhes.models.acquisition.DeviceConfigurationRegisterSpec
	(*DeviceRegister)(nil),                           // 74: io.clbs.openhes.models.acquisition.DeviceRegister
	...
	(*FieldValuesList)(nil),                          // 78: io.clbs.openhes.models.acquisition.FieldValuesList
	(*AttributeSelector)(nil),                        // 79: io.clbs.openhes.models.acquisition.AttributeSelector
	(*DeviceAttributeSelector)(nil),                  // 80: io.clbs.openhes.models.acquisition.DeviceAttributeSelector
	(*CommunicationUnitAttributeSelector)(nil),       // 81: io.clbs.openhes.models.acquisition.CommunicationUnitAttributeSelector
	(*ActionResult)(nil),                             // 82: io.clbs.openhes.models.acquisition.ActionResult
	(*ActionProgressResult)(nil),                     // 83: io.clbs.openhes.models.acquisition.ActionProgressResult
	(*JobEventData)(nil),                             // 84: io.clbs.openhes.models.acquisition.JobEventData
	(*DeviceSpec)(nil),                               // 85: io.clbs.openhes.models.acquisition.DeviceSpec
	(*DeviceStatus)(nil),                             // 86: io.clbs.openhes.models.acquisition.DeviceStatus
	(*DeviceCommunicationUnit)(nil),                  // 87: io.clbs.openhes.models.acquisition.DeviceCommunicationUnit
	(*DefaultDeviceCommunicationUnitAttributes)(nil), // 88: io.clbs.openhes.models.acquisition.DefaultDeviceCommunicationUnitAttributes
	(*JobSpec)(nil),                                  // 89: io.clbs.openhes.models.acquisition.JobSpec
	(*JobActionMapRecord)(nil),                       // 90: io.clbs.openhes.models.acquisition.JobActionMapRecord
	(*JobDoneNotification)(nil),                      // 91: io.clbs.openhes.models.acquisition.JobDoneNotification
	(*DriverInfo)(nil),                               // 92: io.clbs.openhes.models.acquisition.DriverInfo
	(*CommunicationUnit)(nil),                        // 93: io.clbs.openhes.models.acquisition.CommunicationUnit
	(*CommunicationUnitSpec)(nil),                    // 94: io.clbs.openhes.models.acquisition.CommunicationUnitSpec
	(*CommunicationBus)(nil),                         // 95: io.clbs.openhes.models.acquisition.CommunicationBus
	(*CommunicationBusStatus)(nil),                   // 96: io.clbs.openhes.models.acquisition.CommunicationBusStatus
	(*TopologyNode)(nil),                             // 97: io.clbs.openhes.models.acquisition.TopologyNode
	(*TopologyEdge)(nil),                             // 98: io.clbs.openhes.models.acquisition.TopologyEdge
	(*NetworkMap)(nil),                               // 99: io.clbs.openhes.models.acquisition.NetworkMap
	(*CommunicationUnitLogRecord)(nil),               // 100: io.clbs.openhes.models.acquisition.CommunicationUnitLogRecord
	(*ListOfCommunicationUnitLogRecord)(nil),         // 101: io.clbs.openhes.models.acquisition.ListOfCommunicationUnitLogRecord
	nil,                                              // 102: io.clbs.openhes.models.acquisition.JobAction.AttributesEntry
	nil,                                              // 103: io.clbs.openhes.models.acquisition.JobDevice.DeviceAttributesEntry
	nil,                                              // 104: io.clbs.openhes.models.acquisition.ConnectionInfo.AttributesEntry
	nil,                                              // 105: io.clbs.openhes.models.acquisition.JobActionContraints.GetRegisterTypeNameEntry
	nil,                                              // 106: io.clbs.openhes.models.acquisition.JobActionContraints.GetRegisterTypeAttributesEntry
	nil,                                              // 107: io.clbs.openhes.models.acquisition.StartJobData.DeviceAttributesEntry
	nil,                                              // 108: io.clbs.openhes.models.acquisition.DeviceConfigurationRegisterSpec.AttributesEntry
	nil,                                              // 109: io.clbs.openhes.models.acquisition.DeviceConnectionInfo.DeviceAttributesEntry
	nil,                                              // 110: io.clbs.openhes.models.acquisition.DeviceCommunicationUnit.AttributesEntry
	nil,                                              // 111: io.clbs.openhes.models.acquisition.DefaultDeviceCommunicationUnitAttributes.AttributesEntry
	(*durationpb.Duration)(nil),                      // 112: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),                    // 113: google.protobuf.Timestamp
	(*common.FieldDescriptor)(nil),                   // 114: io.clbs.openhes.models.common.FieldDescriptor
	(*common.FormattedMessage)(nil),                  // 115: io.clbs.openhes.models.common.FormattedMessage
	...
	(common.FieldDataType)(0),                        // 118: io.clbs.openhes.models.common.FieldDataType
	(*common.FieldValues)(nil),                       // 119: io.clbs.openhes.models.common.FieldValues
	(common.FilterOperator)(0),                       // 120: io.clbs.openhes.models.common.FilterOperator
	(*common.MetadataFields)(nil),                    // 121: io.clbs.openhes.models.common.MetadataFields
	(*common.FieldValue)(nil),                        // 122: io.clbs.openhes.models.common.FieldValue
	(*common.ListOfString)(nil),                      // 123: io.clbs.openhes.models.common.ListOfString
}
var file_acquisition_shared_proto_depIdxs = []int32{
	112, // 0: io.clbs.openhes.models.acquisition.JobSettings.max_duration:type_name -> google.protobuf.Duration
	0,   // 1: io.clbs.openhes.models.acquisition.JobSettings.priority:type_name -> io.clbs.openhes.models.acquisition.JobPriority
	112, // 2: io.clbs.openhes.models.acquisition.JobSettings.retry_delay:type_name -> google.protobuf.Duration
	112, // 3: io.clbs.openhes.models.acquisition.JobSettings.defer_start:type_name -> google.protobuf.Duration
	113, // 4: io.clbs.openhes.models.acquisition.JobSettings.expires_at:type_name -> google.protobuf.Timestamp
	...
	102, // 6: io.clbs.openhes.models.acquisition.JobAction.attributes:type_name -> io.clbs.openhes.models.acquisition.JobAction.AttributesEntry
	55,  // 7: io.clbs.openhes.models.acquisition.JobAction.get_register:type_name -> io.clbs.openhes.models.acquisition.ActionGetRegister
	56,  // 8: io.clbs.openhes.models.acquisition.JobAction.get_periodical_profile:type_name -> io.clbs.openhes.models.acquisition.ActionGetPeriodicalProfile
	57,  // 9: io.clbs.openhes.models.acquisition.JobAction.get_irregular_profile:type_name -> io.clbs.openhes.models.acquisition.ActionGetIrregularProfile
	58,  // 10: io.clbs.openhes.models.acquisition.JobAction.get_events:type_name -> io.clbs.openhes.models.acquisition.ActionGetEvents
	59,  // 11: io.clbs.openhes.models.acquisition.JobAction.get_device_info:type_name -> io.clbs.openhes.models.acquisition.ActionGetDeviceInfo
	60,  // 12: io.clbs.openhes.models.acquisition.JobAction.sync_clock:type_name -> io.clbs.openhes.models.acquisition.ActionSyncClock
	61,  // 13: io.clbs.openhes.models.acquisition.JobAction.set_relay_state:type_name -> io.clbs.openhes.models.acquisition.ActionSetRelayState
	62,  // 14: io.clbs.openhes.models.acquisition.JobAction.set_disconnector_state:type_name -> io.clbs.openhes.models.acquisition.ActionSetDisconnectorState
	63,  // 15: io.clbs.openhes.models.acquisition.JobAction.get_tou:type_name -> io.clbs.openhes.models.acquisition.ActionGetTou
	...
	67,  // 19: io.clbs.openhes.models.acquisition.JobAction.image_transfer:type_name -> io.clbs.openhes.models.acquisition.ActionFirmwareImageTransfer
	...
	58,  // 23: io.clbs.openhes.models.acquisition.JobActionSet.get_events:type_name -> io.clbs.openhes.models.acquisition.ActionGetEvents
	59,  // 24: io.clbs.openhes.models.acquisition.JobActionSet.get_device_info:type_name -> io.clbs.openhes.models.acquisition.ActionGetDeviceInfo
	60,  // 25: io.clbs.openhes.models.acquisition.JobActionSet.sync_clock:type_name -> io.clbs.openhes.models.acquisition.ActionSyncClock
	61,  // 26: io.clbs.openhes.models.acquisition.JobActionSet.set_relay_state:type_name -> io.clbs.openhes.models.acquisition.ActionSetRelayState
	62,  // 27: io.clbs.openhes.models.acquisition.JobActionSet.set_disconnector_state:type_name -> io.clbs.openhes.models.acquisition.ActionSetDisconnectorState
	63,  // 28: io.clbs.openhes.models.acquisition.JobActionSet.get_tou:type_name -> io.clbs.openhes.models.acquisition.ActionGetTou
	...
	67,  // 32: io.clbs.openhes.models.acquisition.JobActionSet.image_transfer:type_name -> io.clbs.openhes.models.acquisition.ActionFirmwareImageTransfer
	...
	112, // 38: io.clbs.openhes.models.acquisition.ModemInfo.connect_timeout:type_name -> google.protobuf.Duration
	112, // 39: io.clbs.openhes.models.acquisition.ModemInfo.command_timeout:type_name -> google.protobuf.Duration
	...
	54,  // 41: io.clbs.openhes.models.acquisition.ModemInfo.serial_over_ip:type_name -> io.clbs.openhes.models.acquisition.ConnectionTypeControlledSerial
	...
	54,  // 48: io.clbs.openhes.models.acquisition.ConnectionInfo.serial_over_ip:type_name -> io.clbs.openhes.models.acquisition.ConnectionTypeControlledSerial
	...
	104, // 50: io.clbs.openhes.models.acquisition.ConnectionInfo.attributes:type_name -> io.clbs.openhes.models.acquisition.ConnectionInfo.AttributesEntry
	112, // 51: io.clbs.openhes.models.acquisition.ConnectionTypeDirectTcpIp.timeout:type_name -> google.protobuf.Duration
	...
	112, // 53: io.clbs.openhes.models.acquisition.ConnectionTypeSerialDirect.timeout:type_name -> google.protobuf.Duration
	112, // 54: io.clbs.openhes.models.acquisition.ConnectionTypeSerialMoxa.timeout:type_name -> google.protobuf.Duration
	...
	112, // 56: io.clbs.openhes.models.acquisition.ConnectionTypeSerialRfc2217.timeout:type_name -> google.protobuf.Duration
	...
	114, // 59: io.clbs.openhes.models.acquisition.ApplicationProtocolTemplate.attributes:type_name -> io.clbs.openhes.models.common.FieldDescriptor
	...
	114, // 62: io.clbs.openhes.models.acquisition.DataLinkTemplate.attributes:type_name -> io.clbs.openhes.models.common.FieldDescriptor
	...
	53,  // 67: io.clbs.openhes.models.acquisition.DriverTemplates.action_attributes:type_name -> io.clbs.openhes.models.acquisition.JobActionAttributes
	...
	68,  // 69: io.clbs.openhes.models.acquisition.DriverTemplates.action_constraints:type_name -> io.clbs.openhes.models.acquisition.JobActionContraints
	114, // 70: io.clbs.openhes.models.acquisition.DriverTemplates.uknown_device_descriptors:type_name -> io.clbs.openhes.models.common.FieldDescriptor
	...
	39,  // 72: io.clbs.openhes.models.acquisition.ActionProgressUpdate.data:type_name -> io.clbs.openhes.models.acquisition.ActionProgressData
	115, // 73: io.clbs.openhes.models.acquisition.ActionProgressUpdate.error_message:type_name -> io.clbs.openhes.models.common.FormattedMessage
	...
	112, // 75: io.clbs.openhes.models.acquisition.JobProgressUpdate.duration:type_name -> google.protobuf.Duration
	115, // 76: io.clbs.openhes.models.acquisition.JobProgressUpdate.error_message:type_name -> io.clbs.openhes.models.common.FormattedMessage
	116, // 77: io.clbs.openhes.models.acquisition.ActionProgressData.nodata:type_name -> google.protobuf.Empty
	50,  // 78: io.clbs.openhes.models.acquisition.ActionProgressData.registers:type_name -> io.clbs.openhes.models.acquisition.RegisterValues
	47,  // 79: io.clbs.openhes.models.acquisition.ActionProgressData.irregular_profile:type_name -> io.clbs.openhes.models.acquisition.IrregularProfileValues
	45,  // 80: io.clbs.openhes.models.acquisition.ActionProgressData.device_info:type_name -> io.clbs.openhes.models.acquisition.DeviceInfo
	41,  // 81: io.clbs.openhes.models.acquisition.ActionProgressData.events:type_name -> io.clbs.openhes.models.acquisition.EventRecords
	117, // 82: io.clbs.openhes.models.acquisition.ActionProgressData.tou_table:type_name -> io.clbs.openhes.models.acquisition.timeofuse.TimeOfUseTableSpec
	116, // 83: io.clbs.openhes.models.acquisition.ActionData.nodata:type_name -> google.protobuf.Empty
	50,  // 84: io.clbs.openhes.models.acquisition.ActionData.registers:type_name -> io.clbs.openhes.models.acquisition.RegisterValues
	46,  // 85: io.clbs.openhes.models.acquisition.ActionData.profile:type_name -> io.clbs.openhes.models.acquisition.ProfileValues
	47,  // 86: io.clbs.openhes.models.acquisition.ActionData.irregular_profile:type_name -> io.clbs.openhes.models.acquisition.IrregularProfileValues
	45,  // 87: io.clbs.openhes.models.acquisition.ActionData.device_info:type_name -> io.clbs.openhes.models.acquisition.DeviceInfo
	41,  // 88: io.clbs.openhes.models.acquisition.ActionData.events:type_name -> io.clbs.openhes.models.acquisition.EventRecords
	117, // 89: io.clbs.openhes.models.acquisition.ActionData.tou_table:type_name -> io.clbs.openhes.models.acquisition.timeofuse.TimeOfUseTableSpec
	42,  // 90: io.clbs.openhes.models.acquisition.EventRecords.values:type_name -> io.clbs.openhes.models.acquisition.EventRecord
	113, // 91: io.clbs.openhes.models.acquisition.EventRecord.timestamp:type_name -> google.protobuf.Timestamp
	113, // 92: io.clbs.openhes.models.acquisition.DeviceEventRecord.timestamp:type_name -> google.protobuf.Timestamp
	43,  // 93: io.clbs.openhes.models.acquisition.DeviceEvents.events:type_name -> io.clbs.openhes.models.acquisition.DeviceEventRecord
	113, // 94: io.clbs.openhes.models.acquisition.DeviceInfo.info_timestamp:type_name -> google.protobuf.Timestamp
	112, // 95: io.clbs.openhes.models.acquisition.DeviceInfo.clock_delta:type_name -> google.protobuf.Duration
	112, // 96: io.clbs.openhes.models.acquisition.ProfileValues.period:type_name -> google.protobuf.Duration
	49,  // 97: io.clbs.openhes.models.acquisition.ProfileValues.blocks:type_name -> io.clbs.openhes.models.acquisition.ProfileBlock
	48,  // 98: io.clbs.openhes.models.acquisition.IrregularProfileValues.values:type_name -> io.clbs.openhes.models.acquisition.IrregularValue
	113, // 99: io.clbs.openhes.models.acquisition.IrregularValue.timestamp:type_name -> google.protobuf.Timestamp
	52,  // 100: io.clbs.openhes.models.acquisition.IrregularValue.value:type_name -> io.clbs.openhes.models.acquisition.MeasuredValue
	113, // 101: io.clbs.openhes.models.acquisition.ProfileBlock.start_timestamp:type_name -> google.protobuf.Timestamp
	52,  // 102: io.clbs.openhes.models.acquisition.ProfileBlock.values:type_name -> io.clbs.openhes.models.acquisition.MeasuredValue
	51,  // 103: io.clbs.openhes.models.acquisition.RegisterValues.values:type_name -> io.clbs.openhes.models.acquisition.RegisterValue
	113, // 104: io.clbs.openhes.models.acquisition.RegisterValue.timestamp:type_name -> google.protobuf.Timestamp
	52,  // 105: io.clbs.openhes.models.acquisition.RegisterValue.value:type_name -> io.clbs.openhes.models.acquisition.MeasuredValue
	113, // 106: io.clbs.openhes.models.acquisition.MeasuredValue.timestamp_value:type_name -> google.protobuf.Timestamp
	113, // 107: io.clbs.openhes.models.acquisition.MeasuredValue.peak_ts:type_name -> google.protobuf.Timestamp
	9,   // 108: io.clbs.openhes.models.acquisition.JobActionAttributes.type:type_name -> io.clbs.openhes.models.acquisition.ActionType
	114, // 109: io.clbs.openhes.models.acquisition.JobActionAttributes.attributes:type_name -> io.clbs.openhes.models.common.FieldDescriptor
	29,  // 110: io.clbs.openhes.models.acquisition.ConnectionTypeControlledSerial.direct:type_name -> io.clbs.openhes.models.acquisition.ConnectionTypeSerialDirect
	30,  // 111: io.clbs.openhes.models.acquisition.ConnectionTypeControlledSerial.moxa:type_name -> io.clbs.openhes.models.acquisition.ConnectionTypeSerialMoxa
	31,  // 112: io.clbs.openhes.models.acquisition.ConnectionTypeControlledSerial.rfc2217:type_name -> io.clbs.openhes.models.acquisition.ConnectionTypeSerialRfc2217
	25,  // 113: io.clbs.openhes.models.acquisition.ConnectionTypeControlledSerial.config:type_name -> io.clbs.openhes.models.acquisition.SerialConfig
	118, // 114: io.clbs.openhes.models.acquisition.ActionGetRegister.data_type:type_name -> io.clbs.openhes.models.common.FieldDataType
	113, // 115: io.clbs.openhes.models.acquisition.ActionGetPeriodicalProfile.range_start:type_name -> google.protobuf.Timestamp
	113, // 116: io.clbs.openhes.models.acquisition.ActionGetPeriodicalProfile.range_end:type_name -> google.protobuf.Timestamp
	118, // 117: io.clbs.openhes.models.acquisition.ActionGetPeriodicalProfile.data_type:type_name -> io.clbs.openhes.models.common.FieldDataType
	113, // 118: io.clbs.openhes.models.acquisition.ActionGetIrregularProfile.range_start:type_name -> google.protobuf.Timestamp
	113, // 119: io.clbs.openhes.models.acquisition.ActionGetIrregularProfile.range_end:type_name -> google.protobuf.Timestamp
	118, // 120: io.clbs.openhes.models.acquisition.ActionGetIrregularProfile.data_type:type_name -> io.clbs.openhes.models.common.FieldDataType
	113, // 121: io.clbs.openhes.models.acquisition.ActionGetEvents.range_start:type_name -> google.protobuf.Timestamp
	113, // 122: io.clbs.openhes.models.acquisition.ActionGetEvents.range_end:type_name -> google.protobuf.Timestamp
	117, // 123: io.clbs.openhes.models.acquisition.ActionSetTou.table:type_name -> io.clbs.openhes.models.acquisition.timeofuse.TimeOfUseTableSpec
	105, // 124: io.clbs.openhes.models.acquisition.JobActionContraints.get_register_type_name:type_name -> io.clbs.openhes.models.acquisition.JobActionContraints.GetRegisterTypeNameEntry
	106, // 125: io.clbs.openhes.models.acquisition.JobActionContraints.get_register_type_attributes:type_name -> io.clbs.openhes.models.acquisition.JobActionContraints.GetRegisterTypeAttributesEntry
	14,  // 126: io.clbs.openhes.models.acquisition.JobStatus.status:type_name -> io.clbs.openhes.models.acquisition.JobStatusCode
	11,  // 127: io.clbs.openhes.models.acquisition.JobStatus.code:type_name -> io.clbs.openhes.models.acquisition.JobErrorCode
	82,  // 128: io.clbs.openhes.models.acquisition.JobStatus.results:type_name -> io.clbs.openhes.models.acquisition.ActionResult
	113, // 129: io.clbs.openhes.models.acquisition.JobStatus.started_at:type_name -> google.protobuf.Timestamp
	113, // 130: io.clbs.openhes.models.acquisition.JobStatus.finished_at:type_name -> google.protobuf.Timestamp
	45,  // 131: io.clbs.openhes.models.acquisition.JobStatus.device_info:type_name -> io.clbs.openhes.models.acquisition.DeviceInfo
	115, // 132: io.clbs.openhes.models.acquisition.JobStatus.error_message:type_name -> io.clbs.openhes.models.common.FormattedMessage
	14,  // 133: io.clbs.openhes.models.acquisition.JobProgressStatus.status:type_name -> io.clbs.openhes.models.acquisition.JobStatusCode
	11,  // 134: io.clbs.openhes.models.acquisition.JobProgressStatus.code:type_name -> io.clbs.openhes.models.acquisition.JobErrorCode
	83,  // 135: io.clbs.openhes.models.acquisition.JobProgressStatus.results:type_name -> io.clbs.openhes.models.acquisition.ActionProgressResult
	113, // 136: io.clbs.openhes.models.acquisition.JobProgressStatus.started_at:type_name -> google.protobuf.Timestamp
	113, // 137: io.clbs.openhes.models.acquisition.JobProgressStatus.finished_at:type_name -> google.protobuf.Timestamp
	45,  // 138: io.clbs.openhes.models.acquisition.JobProgressStatus.device_info:type_name -> io.clbs.openhes.models.acquisition.DeviceInfo
	115, // 139: io.clbs.openhes.models.acquisition.JobProgressStatus.error_message:type_name -> io.clbs.openhes.models.common.FormattedMessage
	107, // 140: io.clbs.openhes.models.acquisition.StartJobData.device_attributes:type_name -> io.clbs.openhes.models.acquisition.StartJobData.DeviceAttributesEntry
	17,  // 141: io.clbs.openhes.models.acquisition.StartJobData.job_settings:type_name -> io.clbs.openhes.models.acquisition.JobSettings
	18,  // 142: io.clbs.openhes.models.acquisition.StartJobData.job_actions:type_name -> io.clbs.openhes.models.acquisition.JobAction
	8,   // 143: io.clbs.openhes.models.acquisition.StartJobData.app_protocol:type_name -> io.clbs.openhes.models.acquisition.ApplicationProtocol
	13,  // 144: io.clbs.openhes.models.acquisition.DeviceConfigurationRegisterSpec.register_type:type_name -> io.clbs.openhes.models.acquisition.DeviceConfigurationRegisterKind
	108, // 145: io.clbs.openhes.models.acquisition.DeviceConfigurationRegisterSpec.attributes:type_name -> io.clbs.openhes.models.acquisition.DeviceConfigurationRegisterSpec.AttributesEntry
	118, // 146: io.clbs.openhes.models.acquisition.DeviceConfigurationRegisterSpec.data_type:type_name -> io.clbs.openhes.models.common.FieldDataType
	73,  // 147: io.clbs.openhes.models.acquisition.DeviceRegister.spec:type_name -> io.clbs.openhes.models.acquisition.DeviceConfigurationRegisterSpec
	26,  // 148: io.clbs.openhes.models.acquisition.DeviceConnectionInfo.communication_unit:type_name -> io.clbs.openhes.models.acquisition.ConnectionInfo
	8,   // 149: io.clbs.openhes.models.acquisition.DeviceConnectionInfo.app_protocol:type_name -> io.clbs.openhes.models.acquisition.ApplicationProtocol
	109, // 150: io.clbs.openhes.models.acquisition.DeviceConnectionInfo.device_attributes:type_name -> io.clbs.openhes.models.acquisition.DeviceConnectionInfo.DeviceAttributesEntry
	74,  // 151: io.clbs.openhes.models.acquisition.DeviceConnectionInfo.registers:type_name -> io.clbs.openhes.models.acquisition.DeviceRegister
	24,  // 152: io.clbs.openhes.models.acquisition.ListOfModemInfo.items:type_name -> io.clbs.openhes.models.acquisition.ModemInfo
	75,  // 153: io.clbs.openhes.models.acquisition.ListOfConnectionInfo.items:type_name -> io.clbs.openhes.models.acquisition.DeviceConnectionInfo
	119, // 154: io.clbs.openhes.models.acquisition.FieldValuesList.items:type_name -> io.clbs.openhes.models.common.FieldValues
	120, // 155: io.clbs.openhes.models.acquisition.AttributeSelector.operator:type_name -> io.clbs.openhes.models.common.FilterOperator
	118, // 156: io.clbs.openhes.models.acquisition.AttributeSelector.data_type:type_name -> io.clbs.openhes.models.common.FieldDataType
	113, // 157: io.clbs.openhes.models.acquisition.AttributeSelector.date:type_name -> google.protobuf.Timestamp
	79,  // 158: io.clbs.openhes.models.acquisition.DeviceAttributeSelector.attributes:type_name -> io.clbs.openhes.models.acquisition.AttributeSelector
	7,   // 159: io.clbs.openhes.models.acquisition.CommunicationUnitAttributeSelector.link_protocol:type_name -> io.clbs.openhes.models.acquisition.DataLinkProtocol
	79,  // 160: io.clbs.openhes.models.acquisition.CommunicationUnitAttributeSelector.attributes:type_name -> io.clbs.openhes.models.acquisition.AttributeSelector
	10,  // 161: io.clbs.openhes.models.acquisition.ActionResult.status:type_name -> io.clbs.openhes.models.acquisition.ActionResultCode
	40,  // 162: io.clbs.openhes.models.acquisition.ActionResult.data:type_name -> io.clbs.openhes.models.acquisition.ActionData
	115, // 163: io.clbs.openhes.models.acquisition.ActionResult.error_message:type_name -> io.clbs.openhes.models.common.FormattedMessage
	10,  // 164: io.clbs.openhes.models.acquisition.ActionProgressResult.status:type_name -> io.clbs.openhes.models.acquisition.ActionResultCode
	39,  // 165: io.clbs.openhes.models.acquisition.ActionProgressResult.data:type_name -> io.clbs.openhes.models.acquisition.ActionProgressData
	115, // 166: io.clbs.openhes.models.acquisition.ActionProgressResult.error_message:type_name -> io.clbs.openhes.models.common.FormattedMessage
	87,  // 167: io.clbs.openhes.models.acquisition.DeviceSpec.communication_unit_link:type_name -> io.clbs.openhes.models.acquisition.DeviceCommunicationUnit
	88,  // 168: io.clbs.openhes.models.acquisition.DeviceSpec.default_link_attributes:type_name -> io.clbs.openhes.models.acquisition.DefaultDeviceCommunicationUnitAttributes
	45,  // 169: io.clbs.openhes.models.acquisition.DeviceStatus.info:type_name -> io.clbs.openhes.models.acquisition.DeviceInfo
	8,   // 170: io.clbs.openhes.models.acquisition.DeviceCommunicationUnit.app_protocol:type_name -> io.clbs.openhes.models.acquisition.ApplicationProtocol
	110, // 171: io.clbs.openhes.models.acquisition.DeviceCommunicationUnit.attributes:type_name -> io.clbs.openhes.models.acquisition.DeviceCommunicationUnit.AttributesEntry
	8,   // 172: io.clbs.openhes.models.acquisition.DefaultDeviceCommunicationUnitAttributes.app_protocol:type_name -> io.clbs.openhes.models.acquisition.ApplicationProtocol
	111, // 173: io.clbs.openhes.models.acquisition.DefaultDeviceCommunicationUnitAttributes.attributes:type_name -> io.clbs.openhes.models.acquisition.DefaultDeviceCommunicationUnitAttributes.AttributesEntry
	23,  // 174: io.clbs.openhes.models.acquisition.JobSpec.device:type_name -> io.clbs.openhes.models.acquisition.JobDevice
	17,  // 175: io.clbs.openhes.models.acquisition.JobSpec.job_settings:type_name -> io.clbs.openhes.models.acquisition.JobSettings
	18,  // 176: io.clbs.openhes.models.acquisition.JobSpec.job_actions:type_name -> io.clbs.openhes.models.acquisition.JobAction
	90,  // 177: io.clbs.openhes.models.acquisition.JobSpec.job_action_info:type_name -> io.clbs.openhes.models.acquisition.JobActionMapRecord
	89,  // 178: io.clbs.openhes.models.acquisition.JobDoneNotification.spec:type_name -> io.clbs.openhes.models.acquisition.JobSpec
	70,  // 179: io.clbs.openhes.models.acquisition.JobDoneNotification.status:type_name -> io.clbs.openhes.models.acquisition.JobProgressStatus
	94,  // 180: io.clbs.openhes.models.acquisition.CommunicationUnit.spec:type_name -> io.clbs.openhes.models.acquisition.CommunicationUnitSpec
	121, // 181: io.clbs.openhes.models.acquisition.CommunicationUnit.metadata:type_name -> io.clbs.openhes.models.common.MetadataFields
	26,  // 182: io.clbs.openhes.models.acquisition.CommunicationUnitSpec.connection_info:type_name -> io.clbs.openhes.models.acquisition.ConnectionInfo
	96,  // 183: io.clbs.openhes.models.acquisition.CommunicationBus.status:type_name -> io.clbs.openhes.models.acquisition.CommunicationBusStatus
	121, // 184: io.clbs.openhes.models.acquisition.CommunicationBus.metadata:type_name -> io.clbs.openhes.models.common.MetadataFields
	15,  // 185: io.clbs.openhes.models.acquisition.TopologyNode.type:type_name -> io.clbs.openhes.models.acquisition.TopologyNodeType
	119, // 186: io.clbs.openhes.models.acquisition.TopologyNode.attributes:type_name -> io.clbs.openhes.models.common.FieldValues
	119, // 187: io.clbs.openhes.models.acquisition.TopologyEdge.attributes:type_name -> io.clbs.openhes.models.common.FieldValues
	97,  // 188: io.clbs.openhes.models.acquisition.NetworkMap.nodes:type_name -> io.clbs.openhes.models.acquisition.TopologyNode
	98,  // 189: io.clbs.openhes.models.acquisition.NetworkMap.edges:type_name -> io.clbs.openhes.models.acquisition.TopologyEdge
	113, // 190: io.clbs.openhes.models.acquisition.CommunicationUnitLogRecord.timestamp:type_name -> google.protobuf.Timestamp
	16,  // 191: io.clbs.openhes.models.acquisition.CommunicationUnitLogRecord.level:type_name -> io.clbs.openhes.models.acquisition.LogRecordLevel
	100, // 192: io.clbs.openhes.models.acquisition.ListOfCommunicationUnitLogRecord.items:type_name -> io.clbs.openhes.models.acquisition.CommunicationUnitLogRecord
	122, // 193: io.clbs.openhes.models.acquisition.JobAction.AttributesEntry.value:type_name -> io.clbs.openhes.models.common.FieldValue
	122, // 194: io.clbs.openhes.models.acquisition.JobDevice.DeviceAttributesEntry.value:type_name -> io.clbs.openhes.models.common.FieldValue
	122, // 195: io.clbs.openhes.models.acquisition.ConnectionInfo.AttributesEntry.value:type_name -> io.clbs.openhes.models.common.FieldValue
	123, // 196: io.clbs.openhes.models.acquisition.JobActionContraints.GetRegisterTypeAttributesEntry.value:type_name -> io.clbs.openhes.models.common.ListOfString
	122, // 197: io.clbs.openhes.models.acquisition.StartJobData.DeviceAttributesEntry.value:type_name -> io.clbs.openhes.models.common.FieldValue
	122, // 198: io.clbs.openhes.models.acquisition.DeviceConfigurationRegisterSpec.AttributesEntry.value:type_name -> io.clbs.openhes.models.common.FieldValue
	122, // 199: io.clbs.openhes.models.acquisition.DeviceConnectionInfo.DeviceAttributesEntry.value:type_name -> io.clbs.openhes.models.common.FieldValue
	122, // 200: io.clbs.openhes.models.acquisition.DeviceCommunicationUnit.AttributesEntry.value:type_name -> io.clbs.openhes.models.common.FieldValue
	122, // 201: io.clbs.openhes.models.acquisition.DefaultDeviceCommunicationUnitAttributes.AttributesEntry.value:type_name -> io.clbs.openhes.models.common.FieldValue
...
func file_acquisition_shared_proto_init() {
	...
	file_acquisition_shared_proto_msgTypes[2].OneofWrappers = []any{
		...
		(*jobActionSet_ImageTransfer)(nil),
	}
	...
	file_acquisition_shared_proto_msgTypes[22].OneofWrappers = []any{
		(*actionProgressData_Nodata)(nil),
		(*actionProgressData_Registers)(nil),
		(*actionProgressData_Profile)(nil),
		(*actionProgressData_IrregularProfile)(nil),
		(*actionProgressData_DeviceInfo)(nil),
		(*actionProgressData_Events)(nil),
		(*actionProgressData_TouTable)(nil),
	}
	file_acquisition_shared_proto_msgTypes[23].OneofWrappers = []any{
	...
	file_acquisition_shared_proto_msgTypes[35].OneofWrappers = []any{
	...
	file_acquisition_shared_proto_msgTypes[37].OneofWrappers = []any{
