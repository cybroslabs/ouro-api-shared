...
type MetadataFields struct {
	...
	xxx_hidden_Fields        map[string]*anypb.Any  `protobuf:"bytes,1,rep,name=fields" json:"fields,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_ManagedFields map[string]*anypb.Any  `protobuf:"bytes,2,rep,name=managed_fields,json=managedFields" json:"managed_fields,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
var file_common_metadata_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xf5, 0x02, 0x0a, 0x0e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x46, 0x69,
	0x65, 0x6c, 0x64, 0x73, 0x12, 0x51, 0x0a, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x18, 0x01,
