...
type MetadataFields struct {
	...
	xxx_hidden_Fields        map[string]*anypb.Any  `protobuf:"bytes,1,rep,name=fields" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_ManagedFields map[string]*anypb.Any  `protobuf:"bytes,2,rep,name=managed_fields,json=managedFields" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
