...
var file_services_dataproxy_dataproxy_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0xf0, 0x02, 0x0a, 0x10, 0x44, 0x61, 0x74, 0x61, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x53,
...
var file_services_dataproxy_dataproxy_proto_goTypes = []any{
	...
	(*acquisition.ListOfBulk)(nil),        // 4: io.clbs.openhes.models.acquisition.ListOfBulk
	(*acquisition.Bulk)(nil),              // 5: io.clbs.openhes.models.acquisition.Bulk
}
var file_services_dataproxy_dataproxy_proto_depIdxs = []int32{
	...
	3, // 4: io.clbs.openhes.services.dataproxy.DataproxyService.CreateBulk:output_type -> google.protobuf.Empty
	4, // 5: io.clbs.openhes.services.dataproxy.DataproxyService.ListBulks:output_type -> io.clbs.openhes.models.acquisition.ListOfBulk
	5, // 6: io.clbs.openhes.services.dataproxy.DataproxyService.GetBulk:output_type -> io.clbs.openhes.models.acquisition.Bulk
	3, // 7: io.clbs.openhes.services.dataproxy.DataproxyService.CancelBulk:output_type -> google.protobuf.Empty
