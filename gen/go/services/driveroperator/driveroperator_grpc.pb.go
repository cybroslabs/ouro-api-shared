...
const (
	DriverOperatorService_GetDrivers_FullMethodName         = "/io.clbs.openhes.services.driveroperator.DriverOperatorService/GetDrivers"
	DriverOperatorService_SetDriverTemplates_FullMethodName = "/io.clbs.openhes.services.driveroperator.DriverOperatorService/SetDriverTemplates"
	DriverOperatorService_GetDriverTemplates_FullMethodName = "/io.clbs.openhes.services.driveroperator.DriverOperatorService/GetDriverTemplates"
...
type DriverOperatorServiceClient interface {
	...
	GetDrivers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*acquisition.ListOfDriverInfo, error)
...
func (c *driverOperatorServiceClient) GetDrivers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*acquisition.ListOfDriverInfo, error) {
...
func (c *driverOperatorServiceClient) SetDriverTemplates(ctx context.Context, in *acquisition.NegotiateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *driverOperatorServiceClient) GetDriverTemplates(ctx context.Context, in *wrapperspb.StringValue, opts ...grpc.CallOption) (*acquisition.DriverTemplates, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type DriverOperatorServiceServer interface {
	// The method called by the RestApi to get the list of drivers.
	GetDrivers(context.Context, *emptypb.Empty) (*acquisition.ListOfDriverInfo, error)
	// The method called by the Driver to set the driver templates. The parameter contains the driver templates.
...
func (UnimplementedDriverOperatorServiceServer) GetDrivers(context.Context, *emptypb.Empty) (*acquisition.ListOfDriverInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDrivers not implemented")
}
func (UnimplementedDriverOperatorServiceServer) SetDriverTemplates(context.Context, *acquisition.NegotiateRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetDriverTemplates not implemented")
}
func (UnimplementedDriverOperatorServiceServer) GetDriverTemplates(context.Context, *wrapperspb.StringValue) (*acquisition.DriverTemplates, error) {
...
func _DriverOperatorService_SetDriverTemplates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DriverOperatorServiceServer).SetDriverTemplates(ctx, req.(*acquisition.NegotiateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
