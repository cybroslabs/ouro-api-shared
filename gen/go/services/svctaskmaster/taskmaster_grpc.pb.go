...
func (c *taskmasterServiceClient) GetFirmwareImageBlock(ctx context.Context, in *acquisition.GetFirmwareImageBlockRequest, opts ...grpc.CallOption) (*acquisition.FirmwareImageBlock, error) {
	...
	err := c.cc.Invoke(ctx, TaskmasterService_GetFirmwareImageBlock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTaskmasterServiceServer) QueueJobs(context.Context, *acquisition.QueueJobsRequest) (*acquisition.QueueJobsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method QueueJobs not implemented")
}
...
func (UnimplementedTaskmasterServiceServer) SetDriverConfigDefaults(context.Context, *acquisition.SetConfigDefaultsRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method SetDriverConfigDefaults not implemented")
}
func (UnimplementedTaskmasterServiceServer) GetDriverConfig(context.Context, *acquisition.GetDriverConfigRequest) (*common.FieldValues, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDriverConfig not implemented")
}
...
func (UnimplementedTaskmasterServiceServer) ListDevicesByAttributes(context.Context, *acquisition.DeviceAttributeSelector) (*acquisition.ListOfDevice, error) {
	return nil, status.Error(codes.Unimplemented, "method ListDevicesByAttributes not implemented")
}
func (UnimplementedTaskmasterServiceServer) ListCommunicationUnitsByAttributes(context.Context, *acquisition.CommunicationUnitAttributeSelector) (*acquisition.ListOfCommunicationUnit, error) {
	return nil, status.Error(codes.Unimplemented, "method ListCommunicationUnitsByAttributes not implemented")
}
...
func _TaskmasterService_GetFirmwareImageBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(TaskmasterServiceServer).GetFirmwareImageBlock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskmasterService_GetFirmwareImageBlock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskmasterServiceServer).GetFirmwareImageBlock(ctx, req.(*acquisition.GetFirmwareImageBlockRequest))
	}
	return interceptor(ctx, in, info, handler)
}
