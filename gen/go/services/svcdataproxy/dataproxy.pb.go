...
var file_services_svcdataproxy_dataproxy_proto_rawDesc = string([]byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xcf, 0x03, 0x0a, 0x10, 0x44, 0x61, 0x74, 0x61,
	...
	0x6e, 0x2e, 0x42, 0x75, 0x6c, 0x6b, 0x4a, 0x6f, 0x62, 0x42, 0x3f, 0x5a, 0x3d, 0x67, 0x69, 0x74,
...
var file_services_svcdataproxy_dataproxy_proto_goTypes = []any{
	...
	(*acquisition.BulkJob)(nil),           // 6: io.clbs.openhes.models.acquisition.BulkJob
}
var file_services_svcdataproxy_dataproxy_proto_depIdxs = []int32{
	...
	2, // 5: io.clbs.openhes.services.svcdataproxy.DataproxyService.CreateBulk:output_type -> google.protobuf.StringValue
	3, // 6: io.clbs.openhes.services.svcdataproxy.DataproxyService.ListBulks:output_type -> io.clbs.openhes.models.acquisition.ListOfBulk
	4, // 7: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetBulk:output_type -> io.clbs.openhes.models.acquisition.Bulk
	5, // 8: io.clbs.openhes.services.svcdataproxy.DataproxyService.CancelBulk:output_type -> google.protobuf.Empty
	6, // 9: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetBulkJob:output_type -> io.clbs.openhes.models.acquisition.BulkJob
