...
const file_services_svcdataproxy_dataproxy_proto_rawDesc = "" +
	...
	"\aGetBulk\x12\x1c.google.protobuf.StringValue\x1a(.io.clbs.openhes.models.acquisition.Bulk\x12\x86\x01\n" +
...
var file_services_svcdataproxy_dataproxy_proto_goTypes = []any{
	...
	(*acquisition.GetMeterDataRequest)(nil),    // 5: io.clbs.openhes.models.acquisition.GetMeterDataRequest
	(*acquisition.GetMeterEventsRequest)(nil),  // 6: io.clbs.openhes.models.acquisition.GetMeterEventsRequest
	...
	(*acquisition.RegisterValues)(nil),         // 13: io.clbs.openhes.models.acquisition.RegisterValues
	(*acquisition.ProfileValues)(nil),          // 14: io.clbs.openhes.models.acquisition.ProfileValues
	(*acquisition.IrregularProfileValues)(nil), // 15: io.clbs.openhes.models.acquisition.IrregularProfileValues
	(*acquisition.EventRecords)(nil),           // 16: io.clbs.openhes.models.acquisition.EventRecords
}
var file_services_svcdataproxy_dataproxy_proto_depIdxs = []int32{
	...
	5,  // 8: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetMeterDataRegisters:input_type -> io.clbs.openhes.models.acquisition.GetMeterDataRequest
	5,  // 9: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetMeterDataProfiles:input_type -> io.clbs.openhes.models.acquisition.GetMeterDataRequest
	5,  // 10: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetMeterDataIrregularProfiles:input_type -> io.clbs.openhes.models.acquisition.GetMeterDataRequest
	6,  // 11: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetMeterEvents:input_type -> io.clbs.openhes.models.acquisition.GetMeterEventsRequest
	7,  // 12: io.clbs.openhes.services.svcdataproxy.DataproxyService.ListBulks:output_type -> io.clbs.openhes.models.acquisition.ListOfBulk
	8,  // 13: io.clbs.openhes.services.svcdataproxy.DataproxyService.ListBulkJobs:output_type -> io.clbs.openhes.models.acquisition.ListOfBulkJob
	...
	10, // 15: io.clbs.openhes.services.svcdataproxy.DataproxyService.CancelBulk:output_type -> google.protobuf.Empty
	2,  // 16: io.clbs.openhes.services.svcdataproxy.DataproxyService.CreateProxyBulk:output_type -> google.protobuf.StringValue
	11, // 17: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetProxyBulk:output_type -> io.clbs.openhes.models.acquisition.ProxyBulk
	2,  // 18: io.clbs.openhes.services.svcdataproxy.DataproxyService.CreateBulk:output_type -> google.protobuf.StringValue
	12, // 19: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetBulk:output_type -> io.clbs.openhes.models.acquisition.Bulk
	13, // 20: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetMeterDataRegisters:output_type -> io.clbs.openhes.models.acquisition.RegisterValues
	14, // 21: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetMeterDataProfiles:output_type -> io.clbs.openhes.models.acquisition.ProfileValues
	15, // 22: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetMeterDataIrregularProfiles:output_type -> io.clbs.openhes.models.acquisition.IrregularProfileValues
	16, // 23: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetMeterEvents:output_type -> io.clbs.openhes.models.acquisition.EventRecords
