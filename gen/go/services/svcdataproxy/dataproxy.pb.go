...
var file_services_svcdataproxy_dataproxy_proto_rawDesc = []byte{
...
func file_services_svcdataproxy_dataproxy_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_svcdataproxy_dataproxy_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_services_svcdataproxy_dataproxy_proto_rawDesc = nil
