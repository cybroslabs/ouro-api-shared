...
var file_services_svcdataproxy_dataproxy_proto_rawDesc = string([]byte{
	...
	0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xe0, 0x05, 0x0a, 0x10, 0x44,
	...
	0x6e, 0x2e, 0x42, 0x75, 0x6c, 0x6b, 0x4a, 0x6f, 0x62, 0x12, 0x50, 0x0a, 0x09, 0x47, 0x65, 0x74,
	...
	0x73, 0x2f, 0x73, 0x76, 0x63, 0x64, 0x61, 0x74, 0x61, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x62, 0x08,
...
var file_services_svcdataproxy_dataproxy_proto_goTypes = []any{
	...
	(*system.SystemConfig)(nil),                // 5: io.clbs.openhes.models.system.SystemConfig
	(*acquisition.ListOfBulk)(nil),             // 6: io.clbs.openhes.models.acquisition.ListOfBulk
	(*acquisition.Bulk)(nil),                   // 7: io.clbs.openhes.models.acquisition.Bulk
	(*acquisition.BulkJob)(nil),                // 8: io.clbs.openhes.models.acquisition.BulkJob
}
var file_services_svcdataproxy_dataproxy_proto_depIdxs = []int32{
	...
	4, // 6: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetConfig:input_type -> google.protobuf.Empty
	5, // 7: io.clbs.openhes.services.svcdataproxy.DataproxyService.SetConfig:input_type -> io.clbs.openhes.models.system.SystemConfig
	3, // 8: io.clbs.openhes.services.svcdataproxy.DataproxyService.CreateProxyBulk:output_type -> google.protobuf.StringValue
	3, // 9: io.clbs.openhes.services.svcdataproxy.DataproxyService.CreateBulk:output_type -> google.protobuf.StringValue
	6, // 10: io.clbs.openhes.services.svcdataproxy.DataproxyService.ListBulks:output_type -> io.clbs.openhes.models.acquisition.ListOfBulk
	7, // 11: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetBulk:output_type -> io.clbs.openhes.models.acquisition.Bulk
	4, // 12: io.clbs.openhes.services.svcdataproxy.DataproxyService.CancelBulk:output_type -> google.protobuf.Empty
	8, // 13: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetBulkJob:output_type -> io.clbs.openhes.models.acquisition.BulkJob
	5, // 14: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetConfig:output_type -> io.clbs.openhes.models.system.SystemConfig
	4, // 15: io.clbs.openhes.services.svcdataproxy.DataproxyService.SetConfig:output_type -> google.protobuf.Empty
