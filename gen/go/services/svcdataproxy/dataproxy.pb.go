...
const file_services_svcdataproxy_dataproxy_proto_rawDesc = "" +
	...
	"\x0eGetMeterEvents\x129.io.clbs.openhes.models.acquisition.GetMeterEventsRequest\x1a0.io.clbs.openhes.models.acquisition.EventRecords0\x01\x12b\n" +
...
var file_services_svcdataproxy_dataproxy_proto_goTypes = []any{
	...
	(*common.SetManagedFieldsRequest)(nil),     // 9: io.clbs.openhes.models.common.SetManagedFieldsRequest
...
var file_services_svcdataproxy_dataproxy_proto_depIdxs = []int32{
	...
	9,  // 15: io.clbs.openhes.services.svcdataproxy.DataproxyService.SetManagedFields:input_type -> io.clbs.openhes.models.common.SetManagedFieldsRequest
	10, // 16: io.clbs.openhes.services.svcdataproxy.DataproxyService.ListBulks:output_type -> io.clbs.openhes.models.acquisition.ListOfBulk
	11, // 17: io.clbs.openhes.services.svcdataproxy.DataproxyService.ListBulkJobs:output_type -> io.clbs.openhes.models.acquisition.ListOfBulkJob
	12, // 18: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetBulkJob:output_type -> io.clbs.openhes.models.acquisition.BulkJob
	13, // 19: io.clbs.openhes.services.svcdataproxy.DataproxyService.UpdateBulkJob:output_type -> google.protobuf.Empty
	13, // 20: io.clbs.openhes.services.svcdataproxy.DataproxyService.CancelBulk:output_type -> google.protobuf.Empty
	13, // 21: io.clbs.openhes.services.svcdataproxy.DataproxyService.CancelBulkJobs:output_type -> google.protobuf.Empty
	2,  // 22: io.clbs.openhes.services.svcdataproxy.DataproxyService.CreateProxyBulk:output_type -> google.protobuf.StringValue
	14, // 23: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetProxyBulk:output_type -> io.clbs.openhes.models.acquisition.ProxyBulk
	2,  // 24: io.clbs.openhes.services.svcdataproxy.DataproxyService.CreateBulk:output_type -> google.protobuf.StringValue
	15, // 25: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetBulk:output_type -> io.clbs.openhes.models.acquisition.Bulk
	13, // 26: io.clbs.openhes.services.svcdataproxy.DataproxyService.UpdateBulk:output_type -> google.protobuf.Empty
	16, // 27: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetMeterDataRegisters:output_type -> io.clbs.openhes.models.acquisition.RegisterValues
	17, // 28: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetMeterDataProfiles:output_type -> io.clbs.openhes.models.acquisition.ProfileValues
	18, // 29: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetMeterDataIrregularProfiles:output_type -> io.clbs.openhes.models.acquisition.IrregularProfileValues
	19, // 30: io.clbs.openhes.services.svcdataproxy.DataproxyService.GetMeterEvents:output_type -> io.clbs.openhes.models.acquisition.EventRecords
	13, // 31: io.clbs.openhes.services.svcdataproxy.DataproxyService.SetManagedFields:output_type -> google.protobuf.Empty
