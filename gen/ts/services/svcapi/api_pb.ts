...
import type { CommunicationUnitSchema, DeviceEventsSchema, DeviceInfoSchema, IrregularProfileValuesSchema, ListOfCommunicationUnitLogSchema, NetworkMapSchema, ProfileValuesSchema, RegisterValuesSchema } from "../../acquisition/shared_pb";
...
export const ApiService: GenService<{
   ...
   *
   * @generated from rpc io.clbs.openhes.services.svcapi.ApiService.ListCommunicationUnitLogs
   */
  listCommunicationUnitLogs: {
    methodKind: "unary";
    input: typeof ListSelectorSchema;
    output: typeof ListOfCommunicationUnitLogSchema;
  },
  /**
   * @group: Devices
