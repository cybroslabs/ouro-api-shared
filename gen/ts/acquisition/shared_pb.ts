...
export type JobSettings = Message<"io.clbs.openhes.models.acquisition.JobSettings"> & {
  ...
  /**
   * The read path policy for the job. It defines how the job should read data from the device, either from the meter directly or from the data-concentrator first.
   *
...
export type ActionProgressUpdate = Message<"io.clbs.openhes.models.acquisition.ActionProgressUpdate"> & {
  ...
  /**
   * The user error message related to the action which ends up with code ERROR_CODE_ACTION_ERROR, if any. It is used to provide more details about the action result. It can be multiline and should be in English language.
   *
...
export enum ReadPathPolicy {
  /**
   * Keep current behavior (likely data-concentrator first).
   *
  ...
  /**
   * Try meter directly; fall back to data-concentrator if needed and supported.
   *
  ...
  /**
   * Try data-concentrator first; fall back to meter if needed and supported.
   *
