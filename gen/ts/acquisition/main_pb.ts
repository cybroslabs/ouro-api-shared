...
export type DeviceRegister = Message<"io.clbs.openhes.models.acquisition.DeviceRegister"> & {
   ...
   * The register status.
   *
   * @generated from field: io.clbs.openhes.models.acquisition.DeviceRegisterStatus status = 2;
   */
...
export type DeviceRegisterSpec = Message<"io.clbs.openhes.models.acquisition.DeviceRegisterSpec"> & {
   ...
   *
   * @generated from field: string register_type = 1;
   */
  registerType: string;
 ...
 *
 * @generated from message io.clbs.openhes.models.acquisition.DeviceRegisterStatus
 */
export type DeviceRegisterStatus = Message<"io.clbs.openhes.models.acquisition.DeviceRegisterStatus"> & {
};

/**
 * Describes the message io.clbs.openhes.models.acquisition.DeviceRegisterStatus.
 * Use `create(DeviceRegisterStatusSchema)` to create a new message.
 */
export const DeviceRegisterStatusSchema: GenMessage<DeviceRegisterStatus> = /*@__PURE__*/
