...
export type GetDeviceBulksRequest = Message<"io.clbs.openhes.models.acquisition.GetDeviceBulksRequest"> & {
  /**
   * The start timestamp of the bulks selection. If the time range in not specified, the system will return maximum 1000 latest bulks.
   *
   * @generated from field: google.protobuf.Timestamp from = 1;
   */
  from?: Timestamp;
  ...
  /**
   * The end timestamp of the bulks selection. If the time range in not specified, the system will return maximum 1000 latest bulks.
   *
   * @generated from field: google.protobuf.Timestamp to = 2;
   */
  to?: Timestamp;
