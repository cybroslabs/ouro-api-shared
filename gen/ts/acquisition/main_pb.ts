...
export type DeviceDataInfoStatus = Message<"io.clbs.openhes.models.acquisition.DeviceDataInfoStatus"> & {
  ...
  /**
   * The list of variable identifiers.
   *
   ...
   *
   * @generated from field: google.protobuf.Timestamp last_value_at = 4;
   */
