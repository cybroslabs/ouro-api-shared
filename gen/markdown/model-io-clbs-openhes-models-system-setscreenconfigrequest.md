...
| Field | Information |
| --- | --- |
| applicationId | <b>Type:</b> `string`<br><b>Description:</b><br>The application or UI plugin identifier (e.g., "core", "scada-plugin"). |
| screenId | <b>Type:</b> `string`<br><b>Description:</b><br>The screen identifier within the application (e.g., "device-list", "dashboard"). |
