...
type BulkSpec struct {
	...
	Devices       []*pbtaskmaster.JobDevice `protobuf:"bytes,5,rep,name=devices,json=d,proto3" json:"devices,omitempty"`               // The list of devices in the bulk.
	...
	WebhookUrl    *string                   `protobuf:"bytes,8,opt,name=webhook_url,json=h,proto3,oneof" json:"webhook_url,omitempty"` // The webhook URL to call when the bulk is completed.
}
...
type BulkStatus struct {
	...
	Status BulkStatusCode   `protobuf:"varint,1,opt,name=status,json=s,proto3,enum=io.clbs.openhes.pbdataproxy.BulkStatusCode" json:"status,omitempty"` // The job status.
	Jobs   []*BulkJobStatus `protobuf:"bytes,2,rep,name=jobs,json=j,proto3" json:"jobs,omitempty"`                                                      // The list of job statuses.
}
...
type BulkJobStatus struct {
	...
	JobId  string                  `protobuf:"bytes,1,opt,name=job_id,json=i,proto3" json:"job_id,omitempty"` // The job identifier.
	Status *pbtaskmaster.JobStatus `protobuf:"bytes,2,opt,name=status,json=s,proto3" json:"status,omitempty"` // The job status.
}
...
type GetBulkResponse struct {
	...
	Spec   *BulkSpec   `protobuf:"bytes,1,opt,name=spec,json=s,proto3" json:"spec,omitempty"`     // The bulk-job spec.
	Status *BulkStatus `protobuf:"bytes,2,opt,name=status,json=t,proto3" json:"status,omitempty"` // The bulk-job status/data.
}
...
type GetJobStatusResponse struct {
	...
	Status *pbtaskmaster.JobStatus `protobuf:"bytes,1,opt,name=status,json=s,proto3" json:"status,omitempty"` // The status of the job
}
...
var file_pbdataproxy_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x4b, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x42, 0x75, 0x6c, 0x6b,
	...
	,
	...
	0x52, 0x01, 0x64, 0x12, 0x3a, 0x0a, 0x08, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x69, 0x6f, 0x2e, 0x63, 0x6c, 0x62, 0x73, 0x2e,
	0x6f, 0x70, 0x65, 0x6e, 0x68, 0x65, 0x73, 0x2e, 0x70, 0x62, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72,
	0x2e, 0x4a, 0x6f, 0x62, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x52, 0x01, 0x73, 0x12,
	0x3b, 0x0a, 0x0b, 0x6a, 0x6f, 0x62, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x07,
	...
	0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x5f, 0x75, 0x72, 0x6c, 0x22, 0x89, 0x01, 0x0a, 0x0a, 0x42, 0x75,
	0x6c, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x3e, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74,
	...
	0x61, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x42, 0x75, 0x6c, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x01, 0x73, 0x12, 0x3b, 0x0a, 0x04, 0x6a, 0x6f, 0x62, 0x73,
	...
	0x72, 0x6f, 0x78, 0x79, 0x2e, 0x42, 0x75, 0x6c, 0x6b, 0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x52, 0x01, 0x6a, 0x22, 0x5e, 0x0a, 0x0d, 0x42, 0x75, 0x6c, 0x6b, 0x4a, 0x6f, 0x62,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x11, 0x0a, 0x06, 0x6a, 0x6f, 0x62, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x01, 0x69, 0x12, 0x3a, 0x0a, 0x06, 0x73, 0x74, 0x61,
	...
	0x75, 0x73, 0x52, 0x01, 0x73, 0x22, 0x85, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x42, 0x75, 0x6c,
	0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x36, 0x0a, 0x04, 0x73, 0x70, 0x65,
	0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x69, 0x6f, 0x2e, 0x63, 0x6c, 0x62,
	0x73, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x68, 0x65, 0x73, 0x2e, 0x70, 0x62, 0x64, 0x61, 0x74, 0x61,
	0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x42, 0x75, 0x6c, 0x6b, 0x53, 0x70, 0x65, 0x63, 0x52, 0x01,
	...
	,
	...
	0x42, 0x75, 0x6c, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x01, 0x62, 0x22,
	0x24, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x42, 0x75, 0x6c, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x12, 0x0a, 0x07, 0x62, 0x75, 0x6c, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x01, 0x69, 0x22, 0x28, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x4a, 0x6f, 0x62, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x11, 0x0a, 0x06,
	0x6a, 0x6f, 0x62, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x01, 0x69, 0x22,
	0x52, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	...
	0x52, 0x01, 0x73, 0x2a, 0x90, 0x01, 0x0a, 0x0e, 0x42, 0x75, 0x6c, 0x6b, 0x53, 0x74, 0x61, 0x74,
	...
	0x49, 0x52, 0x45, 0x44, 0x10, 0x04, 0x32, 0x85, 0x04, 0x0a, 0x10, 0x44, 0x61, 0x74, 0x61, 0x70,
	0x72, 0x6f, 0x78, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x57, 0x0a, 0x11, 0x4e,
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x4a, 0x6f, 0x62, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x65, 0x64,
	...
	,
	...
	0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x73, 0x0a, 0x0c, 0x47, 0x65, 0x74,
	0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x30, 0x2e, 0x69, 0x6f, 0x2e, 0x63,
	0x6c, 0x62, 0x73, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x68, 0x65, 0x73, 0x2e, 0x70, 0x62, 0x64, 0x61,
	0x74, 0x61, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x47, 0x65, 0x74, 0x4a, 0x6f, 0x62, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x31, 0x2e, 0x69, 0x6f,
	0x2e, 0x63, 0x6c, 0x62, 0x73, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x68, 0x65, 0x73, 0x2e, 0x70, 0x62,
	0x64, 0x61, 0x74, 0x61, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x47, 0x65, 0x74, 0x4a, 0x6f, 0x62,
...
var file_pbdataproxy_proto_goTypes = []interface{}{
	...
	(*pbtaskmaster.JobEventData)(nil), // 16: io.clbs.openhes.pbtaskmaster.JobEventData
...
var file_pbdataproxy_proto_depIdxs = []int32{
	...
	16, // 13: io.clbs.openhes.pbdataproxy.DataproxyService.NotifyJobFinished:input_type -> io.clbs.openhes.pbtaskmaster.JobEventData
	1,  // 14: io.clbs.openhes.pbdataproxy.DataproxyService.CreateBulk:input_type -> io.clbs.openhes.pbdataproxy.CreateBulkRequest
	6,  // 15: io.clbs.openhes.pbdataproxy.DataproxyService.GetBulks:input_type -> io.clbs.openhes.pbdataproxy.GetBulksReuqest
	8,  // 16: io.clbs.openhes.pbdataproxy.DataproxyService.GetBulk:input_type -> io.clbs.openhes.pbdataproxy.GetBulkRequest
	9,  // 17: io.clbs.openhes.pbdataproxy.DataproxyService.GetJobStatus:input_type -> io.clbs.openhes.pbdataproxy.GetJobStatusRequest
	17, // 18: io.clbs.openhes.pbdataproxy.DataproxyService.NotifyJobFinished:output_type -> google.protobuf.Empty
	17, // 19: io.clbs.openhes.pbdataproxy.DataproxyService.CreateBulk:output_type -> google.protobuf.Empty
	7,  // 20: io.clbs.openhes.pbdataproxy.DataproxyService.GetBulks:output_type -> io.clbs.openhes.pbdataproxy.GetBulksResponse
	5,  // 21: io.clbs.openhes.pbdataproxy.DataproxyService.GetBulk:output_type -> io.clbs.openhes.pbdataproxy.GetBulkResponse
	10, // 22: io.clbs.openhes.pbdataproxy.DataproxyService.GetJobStatus:output_type -> io.clbs.openhes.pbdataproxy.GetJobStatusResponse
...
func file_pbdataproxy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pbdataproxy_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateBulkRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pbdataproxy_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pbdataproxy_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
	...
	file_pbdataproxy_proto_msgTypes[1].OneofWrappers = []interface{}{}
