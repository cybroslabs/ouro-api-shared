...
func file_pbdeviceregistry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pbdeviceregistry_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
	...
	file_pbdeviceregistry_proto_msgTypes[4].OneofWrappers = []interface{}{
	...
	file_pbdeviceregistry_proto_msgTypes[12].OneofWrappers = []interface{}{}
	type x struct{}
