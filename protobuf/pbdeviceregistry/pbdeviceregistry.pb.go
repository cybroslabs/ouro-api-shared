...
type CommunicationUnitSpec struct {
	...
	ConnectionType *pbdriver.ConnectionInfo `protobuf:"bytes,4,opt,name=connection_type,json=connectionType,proto3" json:"connection_type,omitempty"` // The connection type.
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *CommunicationUnitSpec) GetConnectionType() *pbdriver.ConnectionInfo {
	if x != nil {
...
var file_pbdeviceregistry_proto_rawDesc = []byte{
	...
	0x32, 0xa5, 0x0f, 0x0a, 0x15, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x52, 0x65, 0x67, 0x69, 0x73,
	...
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x66, 0x0a, 0x0e, 0x47, 0x65,
	0x74, 0x4d, 0x6f, 0x64, 0x65, 0x6d, 0x42, 0x79, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x1c, 0x2e, 0x67,
...
var file_pbdeviceregistry_proto_depIdxs = []int32{
	...
	23, // 2: io.clbs.openhes.pbdeviceregistry.CommunicationUnitSpec.connection_type:type_name -> io.clbs.openhes.pbdriver.ConnectionInfo
	...
	18, // 43: io.clbs.openhes.pbdeviceregistry.DeviceRegistryService.GetModemByPool:output_type -> io.clbs.openhes.pbdeviceregistry.GetModemPoolResponse
