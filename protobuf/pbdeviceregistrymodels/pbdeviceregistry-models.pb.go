...
type DeviceCommunicationUnits struct {
	state                         protoimpl.MessageState            `protogen:"opaque.v1"`
	xxx_hidden_CommunicationUnits *[]*pbdrivermodels.ConnectionInfo `protobuf:"bytes,1,rep,name=communication_units,json=communicationUnits" json:"communication_units,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *DeviceCommunicationUnits) SetCommunicationUnits(v []*pbdrivermodels.ConnectionInfo) {
	x.xxx_hidden_CommunicationUnits = &v
}
...
type DeviceCommunicationUnits_builder struct {
	...
	CommunicationUnits []*pbdrivermodels.ConnectionInfo
}
...
var file_pbdeviceregistry_models_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x6d, 0x75, 0x6e, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x55, 0x6e, 0x69, 0x74,
	0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x75, 0x0a, 0x18,
	0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x43, 0x6f, 0x6d, 0x6d, 0x75, 0x6e, 0x69, 0x63, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x55, 0x6e, 0x69, 0x74, 0x73, 0x12, 0x59, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x6d,
	...
	0x69, 0x74, 0x73, 0x22, 0x3c, 0x0a, 0x0d, 0x4d, 0x6f, 0x64, 0x65, 0x6d, 0x50, 0x6f, 0x6f, 0x6c,
...
var file_pbdeviceregistry_models_proto_depIdxs = []int32{
	...
	26, // 5: io.clbs.openhes.pbdeviceregistry.DeviceSpec.attributes:type_name -> io.clbs.openhes.pbdeviceregistry.DeviceSpec.AttributesEntry
	...
	27, // 7: io.clbs.openhes.pbdeviceregistry.GetDeviceGroupsResponse.groups:type_name -> io.clbs.openhes.pbdeviceregistry.GetDeviceGroupsResponse.GroupsEntry
	...
	30, // 10: io.clbs.openhes.pbdeviceregistry.DeviceCommunicationUnit.app_protocol:type_name -> io.clbs.openhes.pbdriver.ApplicationProtocol
	28, // 11: io.clbs.openhes.pbdeviceregistry.GetDevicesCommunicationUnitsResponse.devices:type_name -> io.clbs.openhes.pbdeviceregistry.GetDevicesCommunicationUnitsResponse.DevicesEntry
	29, // 12: io.clbs.openhes.pbdeviceregistry.DeviceCommunicationUnits.communication_units:type_name -> io.clbs.openhes.pbdriver.ConnectionInfo
	20, // 13: io.clbs.openhes.pbdeviceregistry.GetModemPoolsResponse.pools:type_name -> io.clbs.openhes.pbdeviceregistry.ModemPoolSpec
	31, // 14: io.clbs.openhes.pbdeviceregistry.GetModemPoolResponse.modems:type_name -> io.clbs.openhes.pbdriver.ModemInfo
	31, // 15: io.clbs.openhes.pbdeviceregistry.SetModemRequest.modem:type_name -> io.clbs.openhes.pbdriver.ModemInfo
	32, // 16: io.clbs.openhes.pbdeviceregistry.DeviceSpec.AttributesEntry.value:type_name -> io.clbs.openhes.pbdriver.AttributeValue
	...
	19, // 18: io.clbs.openhes.pbdeviceregistry.GetDevicesCommunicationUnitsResponse.DevicesEntry.value:type_name -> io.clbs.openhes.pbdeviceregistry.DeviceCommunicationUnits
