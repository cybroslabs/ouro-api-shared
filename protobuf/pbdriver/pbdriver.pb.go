...
type ConnectionInfo struct {
	...
	DeviceAttributes map[string]*AttributeValue `protobuf:"bytes,2,rep,name=device_attributes,json=da,proto3" json:"device_attributes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // The connection attributes to the device.
...
type ConnectionInfo_Tcp struct {
	Tcp *ConnectionTypeTcp `protobuf:"bytes,3,opt,name=tcp,json=t,proto3,oneof"` // The TCP connection type.
}

type ConnectionInfo_Phone struct {
	Phone *ConnectionTypePhone `protobuf:"bytes,4,opt,name=phone,json=p,proto3,oneof"` // The phone connection type.
}

type ConnectionInfo_Serial struct {
	Serial *ConnectionTypeSerial `protobuf:"bytes,5,opt,name=serial,json=s,proto3,oneof"` // The serial connection type.
}
...
type DriverTemplates struct {
	...
	CommunicationUnitAttributes []*AttributeDefinition `protobuf:"bytes,1,rep,name=communication_unit_attributes,json=communicationUnitAttributes,proto3" json:"communication_unit_attributes,omitempty"` // The template of the connection attributes related to the communication unit. From top view communication units can be shared for multiple devices. It is represented as a list of attribute definitions.
...
func (x *DriverTemplates) GetCommunicationUnitAttributes() []*AttributeDefinition {
	if x != nil {
		return x.CommunicationUnitAttributes
	}
	return nil
}
...
var file_pbdriver_proto_rawDesc = []byte{
	...
	0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3e, 0x2e, 0x69,
	0x6f, 0x2e, 0x63, 0x6c, 0x62, 0x73, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x68, 0x65, 0x73, 0x2e, 0x70,
	...
	0x12, 0x3d, 0x0a, 0x03, 0x74, 0x63, 0x70, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e,
	...
	0x41, 0x0a, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2d,
	0x2e, 0x69, 0x6f, 0x2e, 0x63, 0x6c, 0x62, 0x73, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x68, 0x65, 0x73,
	...
	0x01, 0x70, 0x12, 0x43, 0x0a, 0x06, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x18, 0x05, 0x20, 0x01,
	...
	0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0xbc, 0x02, 0x0a, 0x0f, 0x44, 0x72, 0x69,
	0x76, 0x65, 0x72, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x12, 0x71, 0x0a, 0x1d,
	0x63, 0x6f, 0x6d, 0x6d, 0x75, 0x6e, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x75, 0x6e,
	0x69, 0x74, 0x5f, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20,
	...
	0x6f, 0x6e, 0x52, 0x1b, 0x63, 0x6f, 0x6d, 0x6d, 0x75, 0x6e, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x55, 0x6e, 0x69, 0x74, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x12,
	0x5a, 0x0a, 0x11, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62,
	...
	0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x10, 0x64, 0x65, 0x76, 0x69, 0x63,
	0x65, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x12, 0x5a, 0x0a, 0x11, 0x61,
	...
	0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x22, 0x26, 0x0a, 0x10, 0x43, 0x61, 0x6e, 0x63, 0x65,
	0x6c, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x06, 0x6a,
	0x6f, 0x62, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22,
	0x97, 0x02, 0x0a, 0x10, 0x4e, 0x65, 0x67, 0x6f, 0x74, 0x69, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71,
	...
	0x67, 0x50, 0x6f, 0x72, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x5f, 0x74,
	0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6d, 0x65, 0x74, 0x65, 0x72,
	...
	0x4a, 0x6f, 0x62, 0x73, 0x12, 0x2a, 0x0a, 0x11, 0x74, 0x79, 0x70, 0x69, 0x63, 0x61, 0x6c, 0x5f,
	0x6d, 0x65, 0x6d, 0x5f, 0x75, 0x73, 0x61, 0x67, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x0f, 0x74, 0x79, 0x70, 0x69, 0x63, 0x61, 0x6c, 0x4d, 0x65, 0x6d, 0x55, 0x73, 0x61, 0x67, 0x65,
	0x12, 0x47, 0x0a, 0x09, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x18, 0x06, 0x20,
	...
	0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x2a, 0x9d, 0x01, 0x0a, 0x0b, 0x4a, 0x6f,
	...
	0x2a, 0x6c, 0x0a, 0x10, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	...
	0x01, 0x12, 0x1b, 0x0a, 0x17, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x5f, 0x43, 0x4f, 0x44, 0x45, 0x5f,
	0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x05, 0x2a, 0x74,
	...
	0x44, 0x45, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x05, 0x12, 0x18, 0x0a, 0x14, 0x4a, 0x4f,
	...
	0x44, 0x45, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x04, 0x32, 0xd5, 0x01, 0x0a, 0x0d, 0x44,
	0x72, 0x69, 0x76, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x61, 0x0a, 0x08,
	0x53, 0x74, 0x61, 0x72, 0x74, 0x4a, 0x6f, 0x62, 0x12, 0x29, 0x2e, 0x69, 0x6f, 0x2e, 0x63, 0x6c,
	0x62, 0x73, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x68, 0x65, 0x73, 0x2e, 0x70, 0x62, 0x64, 0x72, 0x69,
	0x76, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x61, 0x72, 0x74, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x71, 0x75,
...
var file_pbdriver_proto_depIdxs = []int32{
	...
	15, // 47: io.clbs.openhes.pbdriver.DriverTemplates.communication_unit_attributes:type_name -> io.clbs.openhes.pbdriver.AttributeDefinition
	...
	42, // 50: io.clbs.openhes.pbdriver.NegotiateRequest.templates:type_name -> io.clbs.openhes.pbdriver.DriverTemplates
	40, // 51: io.clbs.openhes.pbdriver.ConnectionInfo.DeviceAttributesEntry.value:type_name -> io.clbs.openhes.pbdriver.AttributeValue
	40, // 52: io.clbs.openhes.pbdriver.JobAction.AttributesEntry.value:type_name -> io.clbs.openhes.pbdriver.AttributeValue
	17, // 53: io.clbs.openhes.pbdriver.DriverService.StartJob:input_type -> io.clbs.openhes.pbdriver.StartJobRequest
	43, // 54: io.clbs.openhes.pbdriver.DriverService.CancelJob:input_type -> io.clbs.openhes.pbdriver.CancelJobRequest
	6,  // 55: io.clbs.openhes.pbdriver.DriverService.StartJob:output_type -> io.clbs.openhes.pbdriver.ProgressUpdate
	41, // 56: io.clbs.openhes.pbdriver.DriverService.CancelJob:output_type -> io.clbs.openhes.pbdriver.CommonResponse
