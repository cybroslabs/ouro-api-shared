...
const (
	// The IEC 62056-21 (IEC-61107, VDEW) protocol. In combination with DLMS protocol the driver starts by IEC and switches to the mode E and typically DLMS over HDLC. Supports client/server addressing = multiple devices on the same line.
	DataLinkProtocol_LINKPROTO_IEC_62056_21 DataLinkProtocol = 0
	// The HDLC framing. Supports client/server addressing = multiple devices on the same line.
	DataLinkProtocol_LINKPROTO_HDLC DataLinkProtocol = 1
	// The COSEM wrapper. Supports client/server addressing = multiple devices on the same line.
	DataLinkProtocol_LINKPROTO_COSEM_WRAPPER DataLinkProtocol = 2
	// The data link protocol is not applicable, this is applicable only for listening communication type.
...
type StartJobsRequest struct {
	...
	Jobs           []*StartJobData `protobuf:"bytes,1,rep,name=jobs,json=j,proto3" json:"jobs,omitempty"`                        // The list of jobs to be started with the same connection info.
}
...
type StartJobData struct {
	...
	JobId            string                     `protobuf:"bytes,2,opt,name=job_id,json=id,proto3" json:"job_id,omitempty"`                                                                                                               // The job identifier.
...
type ModemOverControlledSerial struct {
	...
	Serial       *ConnectionTypeControlledSerial `protobuf:"bytes,1,opt,name=serial,json=s,proto3" json:"serial,omitempty"`                // The serial connection type.
	SerialConfig *SerialConfig                   `protobuf:"bytes,2,opt,name=serial_config,json=sc,proto3" json:"serial_config,omitempty"` // The serial port configuration related to the modem.
}
...
func (m *ConnectionTypeControlledSerial) GetConverter() isConnectionTypeControlledSerial_Converter {
	if m != nil {
		return m.Converter
	}
	return nil
...
func (x *ConnectionTypeControlledSerial) GetMoxa() *ConnectionTypeSerialMoxa {
	if x, ok := x.GetConverter().(*ConnectionTypeControlledSerial_Moxa); ok {
		return x.Moxa
	}
	return nil
}
...
type ConnectionTypeControlledSerial_Moxa struct {
	Moxa *ConnectionTypeSerialMoxa `protobuf:"bytes,1,opt,name=moxa,json=m,proto3,oneof"` // The Moxa connection type.
}
...
type ModemInfo struct {
	...
	Id             string `protobuf:"bytes,12,opt,name=id,json=i,proto3" json:"id,omitempty"`                            // The modem identifier. It is automatically generated during creation.
	Name           string `protobuf:"bytes,11,opt,name=name,json=n,proto3" json:"name,omitempty"`                        // The name of the modem.
	AtInit         string `protobuf:"bytes,1,opt,name=at_init,json=ati,proto3" json:"at_init,omitempty"`                 // The modem initialization command.
	AtTest         string `protobuf:"bytes,2,opt,name=at_test,json=att,proto3" json:"at_test,omitempty"`                 // The modem test command.
	AtConfig       string `protobuf:"bytes,3,opt,name=at_config,json=atc,proto3" json:"at_config,omitempty"`             // The modem configuration command.
	AtDial         string `protobuf:"bytes,4,opt,name=at_dial,json=atd,proto3" json:"at_dial,omitempty"`                 // The modem dial command.
	AtHangup       string `protobuf:"bytes,5,opt,name=at_hangup,json=ath,proto3" json:"at_hangup,omitempty"`             // The modem hangup command.
	AtEscape       string `protobuf:"bytes,6,opt,name=at_escape,json=ate,proto3" json:"at_escape,omitempty"`             // The modem escape command.
	AtDsr          bool   `protobuf:"varint,7,opt,name=at_dsr,json=ats,proto3" json:"at_dsr,omitempty"`                  // The modem DSR command.
	ConnectTimeout uint32 `protobuf:"varint,8,opt,name=connect_timeout,json=ct,proto3" json:"connect_timeout,omitempty"` // The modem connection timeout.
	// The modem connection description.
	//
	// Types that are assignable to ModemConnection:
	//
	//	*ModemInfo_Tcpip
...
func (m *ModemInfo) GetModemConnection() isModemInfo_ModemConnection {
	if m != nil {
		return m.ModemConnection
	}
	return nil
}

func (x *ModemInfo) GetTcpip() *ConnectionTypeDirectTcpIp {
	if x, ok := x.GetModemConnection().(*ModemInfo_Tcpip); ok {
		return x.Tcpip
	}
	return nil
}
...
func (x *ModemInfo) GetSerialOverIp() *ModemOverControlledSerial {
	if x, ok := x.GetModemConnection().(*ModemInfo_SerialOverIp); ok {
...
type ModemInfo_Tcpip struct {
	Tcpip *ConnectionTypeDirectTcpIp `protobuf:"bytes,9,opt,name=tcpip,json=t,proto3,oneof"` // The TCP connection type. The modem has either TCP or there is a IP-to-serial converter which handles the serial configuration so no additional serial configuration is needed.
}

type ModemInfo_SerialOverIp struct {
	SerialOverIp *ModemOverControlledSerial `protobuf:"bytes,10,opt,name=serial_over_ip,json=soi,proto3,oneof"` // The serial over IP connection type. The modem is connected to a IP-to-serial converter and the converter requires serial port configuration to be set.
}
...
type SerialConfig struct {
	...
	BaudRate SerialConfigBaudRate `protobuf:"varint,1,opt,name=baud_rate,json=b,proto3,enum=io.clbs.openhes.pbdriver.SerialConfigBaudRate" json:"baud_rate,omitempty"` // The baud rate.
	Parity   SerialConfigParity   `protobuf:"varint,2,opt,name=parity,json=p,proto3,enum=io.clbs.openhes.pbdriver.SerialConfigParity" json:"parity,omitempty"`         // The parity.
	DataBits SerialConfigDataBits `protobuf:"varint,3,opt,name=data_bits,json=d,proto3,enum=io.clbs.openhes.pbdriver.SerialConfigDataBits" json:"data_bits,omitempty"` // The data bits.
	StopBits SerialConfigStopBits `protobuf:"varint,4,opt,name=stop_bits,json=s,proto3,enum=io.clbs.openhes.pbdriver.SerialConfigStopBits" json:"stop_bits,omitempty"` // The stop bits.
}
...
type ConnectionInfo struct {
	...
	Modem *ModemInfo `protobuf:"bytes,4,opt,name=modem,json=pm,proto3,oneof" json:"modem,omitempty"`
}
...
func (x *ConnectionInfo) GetTcpip() *ConnectionTypeDirectTcpIp {
	if x, ok := x.GetConnection().(*ConnectionInfo_Tcpip); ok {
		return x.Tcpip
	}
	return nil
}
...
func (x *ConnectionInfo) GetModemPool() *ConnectionTypeModemPool {
	if x, ok := x.GetConnection().(*ConnectionInfo_ModemPool); ok {
		return x.ModemPool
	}
	return nil
}
...
func (x *ConnectionInfo) GetSerialOverIp() *ConnectionTypeControlledSerial {
	if x, ok := x.GetConnection().(*ConnectionInfo_SerialOverIp); ok {
		return x.SerialOverIp
	}
	return nil
}

func (x *ConnectionInfo) GetModem() *ModemInfo {
	if x != nil {
		return x.Modem
	}
	return nil
...
type ConnectionInfo_Tcpip struct {
	Tcpip *ConnectionTypeDirectTcpIp `protobuf:"bytes,1,opt,name=tcpip,json=t,proto3,oneof"` // The TCP connection type.
}

type ConnectionInfo_ModemPool struct {
	ModemPool *ConnectionTypeModemPool `protobuf:"bytes,2,opt,name=modem_pool,json=p,proto3,oneof"` // The phone connection type.
}

type ConnectionInfo_SerialOverIp struct {
	SerialOverIp *ConnectionTypeControlledSerial `protobuf:"bytes,3,opt,name=serial_over_ip,json=sip,proto3,oneof"` // The serial over IP connection type.
}
...
type ConnectionTypeModemPool struct {
	...
	PoolId string `protobuf:"bytes,2,opt,name=pool_id,json=p,proto3" json:"pool_id,omitempty"` // The modem pool identifier. The pool is a group of modems that can be used to connect to the device. Final modem is selected by the Taskmaster at the time of the job start.
}
...
type ConnectionTypeSerialMoxa struct {
	...
	Host        string `protobuf:"bytes,1,opt,name=host,json=h,proto3" json:"host,omitempty"`                 // The host name or IP address of the device to connect to.
	DataPort    uint32 `protobuf:"varint,2,opt,name=dataPort,json=dp,proto3" json:"dataPort,omitempty"`       // The TCP port number of the device to connect to - data port.
	CommandPort uint32 `protobuf:"varint,3,opt,name=commandPort,json=cp,proto3" json:"commandPort,omitempty"` // The TCP port number of the device to connect to - command port.
}
...
type ApplicationProtocolTemplate struct {
	...
	Protocol ApplicationProtocol `protobuf:"varint,1,opt,name=protocol,json=p,proto3,enum=io.clbs.openhes.pbdriver.ApplicationProtocol" json:"protocol,omitempty"`
	// The list of attribute definitions for the protocol.
	Attributes []*AttributeDefinition `protobuf:"bytes,2,rep,name=attributes,json=a,proto3" json:"attributes,omitempty"`
}
...
type DataLinkTemplate struct {
	...
	LinkProtocols DataLinkProtocol `protobuf:"varint,2,opt,name=link_protocols,json=lp,proto3,enum=io.clbs.openhes.pbdriver.DataLinkProtocol" json:"link_protocols,omitempty"`
	// The list of application protocols supported by the driver.
	AppProtocols []*ApplicationProtocolTemplate `protobuf:"bytes,3,rep,name=app_protocols,json=ap,proto3" json:"app_protocols,omitempty"`
}
...
func (x *DataLinkTemplate) GetLinkProtocols() DataLinkProtocol {
	if x != nil {
		return x.LinkProtocols
	}
	return DataLinkProtocol_LINKPROTO_IEC_62056_21
}

func (x *DataLinkTemplate) GetAppProtocols() []*ApplicationProtocolTemplate {
	if x != nil {
...
type CommunicationTemplate struct {
	...
	Type CommunicationType `protobuf:"varint,1,opt,name=type,json=t,proto3,enum=io.clbs.openhes.pbdriver.CommunicationType" json:"type,omitempty"`
	// The list of data link protocols and their app protocols supported by the driver.
	Datalink []*DataLinkTemplate `protobuf:"bytes,2,rep,name=datalink,json=dl,proto3" json:"datalink,omitempty"`
}
...
func (x *CommunicationTemplate) GetDatalink() []*DataLinkTemplate {
	if x != nil {
		return x.Datalink
	}
	return nil
...
type DriverTemplates struct {
	...
	// The metadata of the communication templates. Every template represents an option how the drivers allows to communicate. The driver can support multiple communication templates.
	CommunicationTemplates []*CommunicationTemplate `protobuf:"bytes,2,rep,name=communication_templates,json=ct,proto3" json:"communication_templates,omitempty"`
	// The template of the connection attributes related to the device. It is represented as a list of attribute definitions.
	DeviceAttributes []*AttributeDefinition `protobuf:"bytes,3,rep,name=device_attributes,json=ad,proto3" json:"device_attributes,omitempty"`
	// The templates of the job actions for all supported action types.
	ActionAttributes []*JobActionAttributes `protobuf:"bytes,4,rep,name=action_attributes,json=aa,proto3" json:"action_attributes,omitempty"`
}
...
var file_pbdriver_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x52, 0x01, 0x61, 0x22, 0x92, 0x01, 0x0a, 0x10, 0x53, 0x74, 0x61, 0x72, 0x74,
	0x4a, 0x6f, 0x62, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x45, 0x0a, 0x0f, 0x63,
	...
	0x70, 0x65, 0x6e, 0x68, 0x65, 0x73, 0x2e, 0x70, 0x62, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x2e,
	0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0
 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f,
	0x53, 0x45, 0x52, 0x49, 0x41, 0x4c, 0x5f, 0x4c, 0x49, 0x4e, 0x45, 0x5f, 0x4d, 0x4f, 0x58, 0x41,
	0x10, 0x02, 0x12, 0x20, 0x0a, 0x1c, 0x43, 0x4f, 0x4d, 0x4d, 0x55, 0x4e, 0x49, 0x43, 0x41, 0x54,
	0x49, 0x4f, 0x4e, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4c, 0x49, 0x53, 0x54, 0x45, 0x4e, 0x49,
	0x4e, 0x47, 0x10, 0x63, 0x2a, 0x7d, 0x0a, 0x10, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x6e, 0x6b,
	...
	0x50, 0x45, 0x52, 0x10, 0x02, 0x12, 0x1c, 0x0a, 0x18, 0x4c, 0x49, 0x4e, 0x4b, 0x50, 0x52, 0x4f,
	...
	0x54, 0x54, 0x10, 0x06, 0x32, 0xd6, 0x01, 0x0a, 0x0d, 0x44, 0x72, 0x69, 0x76, 0x65, 0x72, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x62, 0x0a, 0x08, 0x53, 0x74, 0x61, 0x72, 0x74, 0x4a,
	...
	0x61, 0x72, 0x74, 0x4a, 0x6f, 0x62, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x28,
	0x2e, 0x69, 0x6f, 0x2e, 0x63, 0x6c, 0x62, 0x73, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x68, 0x65, 0x73,
	...
	0x65, 0x6e, 0x68, 0x65, 0x73, 0x2e, 0x70, 0x62, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x2e, 0x43,
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x34, 0x5a,
	0x32, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x79, 0x62, 0x72,
...
var file_pbdriver_proto_msgTypes = make([]protoimpl.MessageInfo, 49)
var file_pbdriver_proto_goTypes = []any{
	...
	(*DriverTemplates)(nil),                // 57: io.clbs.openhes.pbdriver.DriverTemplates
	(*CancelJobRequest)(nil),               // 58: io.clbs.openhes.pbdriver.CancelJobRequest
	(*NegotiateRequest)(nil),               // 59: io.clbs.openhes.pbdriver.NegotiateRequest
	nil,                                    // 60: io.clbs.openhes.pbdriver.StartJobData.DeviceAttributesEntry
	nil,                                    // 61: io.clbs.openhes.pbdriver.JobAction.AttributesEntry
...
var file_pbdriver_proto_depIdxs = []int32{
	...
	62, // 5: io.clbs.openhes.pbdriver.ActionData.nodata:type_name -> google.protobuf.Empty
	...
	63, // 9: io.clbs.openhes.pbdriver.ProfileBlok.start_timestamp:type_name -> google.protobuf.Timestamp
	...
	63, // 12: io.clbs.openhes.pbdriver.BillingValue.timestamp:type_name -> google.protobuf.Timestamp
	21, // 13: io.clbs.openhes.pbdriver.BillingValue.value:type_name -> io.clbs.openhes.pbdriver.MeasuredValue
	5,  // 14: io.clbs.openhes.pbdriver.AttributeDefinition.type:type_name -> io.clbs.openhes.pbdriver.AttributeType
	52, // 15: io.clbs.openhes.pbdriver.AttributeDefinition.default_value:type_name -> io.clbs.openhes.pbdriver.AttributeValue
	6,  // 16: io.clbs.openhes.pbdriver.JobActionAttributes.type:type_name -> io.clbs.openhes.pbdriver.ActionType
	22, // 17: io.clbs.openhes.pbdriver.JobActionAttributes.attributes:type_name -> io.clbs.openhes.pbdriver.AttributeDefinition
	30, // 18: io.clbs.openhes.pbdriver.StartJobsRequest.connection_info:type_name -> io.clbs.openhes.pbdriver.ConnectionInfo
	25, // 19: io.clbs.openhes.pbdriver.StartJobsRequest.jobs:type_name -> io.clbs.openhes.pbdriver.StartJobData
	60, // 20: io.clbs.openhes.pbdriver.StartJobData.device_attributes:type_name -> io.clbs.openhes.pbdriver.StartJobData.DeviceAttributesEntry
	34, // 21: io.clbs.openhes.pbdriver.StartJobData.job_settings:type_name -> io.clbs.openhes.pbdriver.JobSettings
	35, // 22: io.clbs.openhes.pbdriver.StartJobData.job_actions:type_name -> io.clbs.openhes.pbdriver.JobAction
	27, // 23: io.clbs.openhes.pbdriver.ModemOverControlledSerial.serial:type_name -> io.clbs.openhes.pbdriver.ConnectionTypeControlledSerial
	29, // 24: io.clbs.openhes.pbdriver.ModemOverControlledSerial.serial_config:type_name -> io.clbs.openhes.pbdriver.SerialConfig
	33, // 25: io.clbs.openhes.pbdriver.ConnectionTypeControlledSerial.moxa:type_name -> io.clbs.openhes.pbdriver.ConnectionTypeSerialMoxa
	31, // 26: io.clbs.openhes.pbdriver.ModemInfo.tcpip:type_name -> io.clbs.openhes.pbdriver.ConnectionTypeDirectTcpIp
	26, // 27: io.clbs.openhes.pbdriver.ModemInfo.serial_over_ip:type_name -> io.clbs.openhes.pbdriver.ModemOverControlledSerial
	...
	31, // 32: io.clbs.openhes.pbdriver.ConnectionInfo.tcpip:type_name -> io.clbs.openhes.pbdriver.ConnectionTypeDirectTcpIp
	32, // 33: io.clbs.openhes.pbdriver.ConnectionInfo.modem_pool:type_name -> io.clbs.openhes.pbdriver.ConnectionTypeModemPool
	27, // 34: io.clbs.openhes.pbdriver.ConnectionInfo.serial_over_ip:type_name -> io.clbs.openhes.pbdriver.ConnectionTypeControlledSerial
	28, // 35: io.clbs.openhes.pbdriver.ConnectionInfo.modem:type_name -> io.clbs.openhes.pbdriver.ModemInfo
	4,  // 36: io.clbs.openhes.pbdriver.JobSettings.priority:type_name -> io.clbs.openhes.pbdriver.JobPriority
	63, // 37: io.clbs.openhes.pbdriver.JobSettings.expires_at:type_name -> google.protobuf.Timestamp
	61, // 38: io.clbs.openhes.pbdriver.JobAction.attributes:type_name -> io.clbs.openhes.pbdriver.JobAction.AttributesEntry
	36, // 39: io.clbs.openhes.pbdriver.JobAction.get_register:type_name -> io.clbs.openhes.pbdriver.ActionGetRegister
	37, // 40: io.clbs.openhes.pbdriver.JobAction.get_periodical_profile:type_name -> io.clbs.openhes.pbdriver.ActionGetPeriodicalProfile
	38, // 41: io.clbs.openhes.pbdriver.JobAction.get_irregular_profile:type_name -> io.clbs.openhes.pbdriver.ActionGetIrregularProfile
	39, // 42: io.clbs.openhes.pbdriver.JobAction.get_events:type_name -> io.clbs.openhes.pbdriver.ActionGetEvents
	40, // 43: io.clbs.openhes.pbdriver.JobAction.get_clock:type_name -> io.clbs.openhes.pbdriver.ActionGetClock
	41, // 44: io.clbs.openhes.pbdriver.JobAction.sync_clock:type_name -> io.clbs.openhes.pbdriver.ActionSyncClock
	42, // 45: io.clbs.openhes.pbdriver.JobAction.get_relay_state:type_name -> io.clbs.openhes.pbdriver.ActionGetRelayState
	43, // 46: io.clbs.openhes.pbdriver.JobAction.set_relay_state:type_name -> io.clbs.openhes.pbdriver.ActionSetRelayState
	44, // 47: io.clbs.openhes.pbdriver.JobAction.get_disconnector_state:type_name -> io.clbs.openhes.pbdriver.ActionGetDisconnectorState
	45, // 48: io.clbs.openhes.pbdriver.JobAction.set_disconnector_state:type_name -> io.clbs.openhes.pbdriver.ActionSetDisconnectorState
	46, // 49: io.clbs.openhes.pbdriver.JobAction.get_tou:type_name -> io.clbs.openhes.pbdriver.ActionGetTou
	47, // 50: io.clbs.openhes.pbdriver.JobAction.set_tou:type_name -> io.clbs.openhes.pbdriver.ActionSetTou
	48, // 51: io.clbs.openhes.pbdriver.JobAction.get_limiter:type_name -> io.clbs.openhes.pbdriver.ActionGetLimiter
	49, // 52: io.clbs.openhes.pbdriver.JobAction.set_limiter:type_name -> io.clbs.openhes.pbdriver.ActionSetLimiter
	50, // 53: io.clbs.openhes.pbdriver.JobAction.reset_billing_period:type_name -> io.clbs.openhes.pbdriver.ActionResetBillingPeriod
	51, // 54: io.clbs.openhes.pbdriver.JobAction.fw_update:type_name -> io.clbs.openhes.pbdriver.ActionFwUpdate
	63, // 55: io.clbs.openhes.pbdriver.ActionGetPeriodicalProfile.from:type_name -> google.protobuf.Timestamp
	63, // 56: io.clbs.openhes.pbdriver.ActionGetPeriodicalProfile.to:type_name -> google.protobuf.Timestamp
	9,  // 57: io.clbs.openhes.pbdriver.CommonResponse.result:type_name -> io.clbs.openhes.pbdriver.ErrorCode
	12, // 58: io.clbs.openhes.pbdriver.ApplicationProtocolTemplate.protocol:type_name -> io.clbs.openhes.pbdriver.ApplicationProtocol
	22, // 59: io.clbs.openhes.pbdriver.ApplicationProtocolTemplate.attributes:type_name -> io.clbs.openhes.pbdriver.AttributeDefinition
	11, // 60: io.clbs.openhes.pbdriver.DataLinkTemplate.link_protocols:type_name -> io.clbs.openhes.pbdriver.DataLinkProtocol
	54, // 61: io.clbs.openhes.pbdriver.DataLinkTemplate.app_protocols:type_name -> io.clbs.openhes.pbdriver.ApplicationProtocolTemplate
	10, // 62: io.clbs.openhes.pbdriver.CommunicationTemplate.type:type_name -> io.clbs.openhes.pbdriver.CommunicationType
	55, // 63: io.clbs.openhes.pbdriver.CommunicationTemplate.datalink:type_name -> io.clbs.openhes.pbdriver.DataLinkTemplate
	56, // 64: io.clbs.openhes.pbdriver.DriverTemplates.communication_templates:type_name -> io.clbs.openhes.pbdriver.CommunicationTemplate
	22, // 65: io.clbs.openhes.pbdriver.DriverTemplates.device_attributes:type_name -> io.clbs.openhes.pbdriver.AttributeDefinition
	23, // 66: io.clbs.openhes.pbdriver.DriverTemplates.action_attributes:type_name -> io.clbs.openhes.pbdriver.JobActionAttributes
	57, // 67: io.clbs.openhes.pbdriver.NegotiateRequest.templates:type_name -> io.clbs.openhes.pbdriver.DriverTemplates
	52, // 68: io.clbs.openhes.pbdriver.StartJobData.DeviceAttributesEntry.value:type_name -> io.clbs.openhes.pbdriver.AttributeValue
	52, // 69: io.clbs.openhes.pbdriver.JobAction.AttributesEntry.value:type_name -> io.clbs.openhes.pbdriver.AttributeValue
	24, // 70: io.clbs.openhes.pbdriver.DriverService.StartJob:input_type -> io.clbs.openhes.pbdriver.StartJobsRequest
	58, // 71: io.clbs.openhes.pbdriver.DriverService.CancelJob:input_type -> io.clbs.openhes.pbdriver.CancelJobRequest
	13, // 72: io.clbs.openhes.pbdriver.DriverService.StartJob:output_type -> io.clbs.openhes.pbdriver.ProgressUpdate
	53, // 73: io.clbs.openhes.pbdriver.DriverService.CancelJob:output_type -> io.clbs.openhes.pbdriver.CommonResponse
