...
type GetDriversResponse struct {
	...
	xxx_hidden_Drivers     *[]*DriverInfo           `protobuf:"bytes,2,rep,name=drivers" json:"drivers,omitempty"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
func (x *GetDriversResponse) SetResult(v pbdrivermodels.ErrorCode) {
	x.xxx_hidden_Result = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 2)
}

func (x *GetDriversResponse) SetDrivers(v []*DriverInfo) {
	x.xxx_hidden_Drivers = &v
}

func (x *GetDriversResponse) HasResult() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *GetDriversResponse) ClearResult() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_Result = pbdrivermodels.ErrorCode_ERROR_CODE_OK
}

type GetDriversResponse_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 GetDriversResponse_builder) Build() *GetDriversResponse {
	m0 := &GetDriversResponse{}
	b, x := &b0, m0
	_, _ = b, x
	if b.Result != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 0, 2)
...
var file_pbdriveroperator_models_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x65, 0x6c, 0x73, 0x62, 0x08, 0x65, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x70,
	0xe8, 0x07,
}
