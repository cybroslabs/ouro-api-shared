...
func (*SetDriverScaleRequest) Descriptor() ([]byte, []int) {
	return file_pbdriveroperator_models_proto_rawDescGZIP(), []int{0}
}
...
func (*GetDriverScaleRequest) Descriptor() ([]byte, []int) {
	return file_pbdriveroperator_models_proto_rawDescGZIP(), []int{1}
}
...
func (*StartUpgradeRequest) Descriptor() ([]byte, []int) {
	return file_pbdriveroperator_models_proto_rawDescGZIP(), []int{2}
}
...
func (*GetDriverTemplatesRequest) Descriptor() ([]byte, []int) {
	return file_pbdriveroperator_models_proto_rawDescGZIP(), []int{3}
}
...
func (*DriverInfo) Descriptor() ([]byte, []int) {
	return file_pbdriveroperator_models_proto_rawDescGZIP(), []int{4}
}
...
type GetDriversResponse struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Result        pbdrivermodels.ErrorCode `protobuf:"varint,1,opt,name=result,proto3,enum=io.clbs.openhes.pbdriver.ErrorCode" json:"result,omitempty"` // The result of the operation.
...
func (*GetDriversResponse) Descriptor() ([]byte, []int) {
	return file_pbdriveroperator_models_proto_rawDescGZIP(), []int{5}
}

func (x *GetDriversResponse) GetResult() pbdrivermodels.ErrorCode {
	if x != nil {
		return x.Result
	}
...
var file_pbdriveroperator_models_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x99, 0x01, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x44, 0x72, 0x69,
	...
	0x65, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x46, 0x0a, 0x07, 0x64, 0x72, 0x69,
	0x76, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x69, 0x6f, 0x2e,
	0x63, 0x6c, 0x62, 0x73, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x68, 0x65, 0x73, 0x2e, 0x70, 0x62, 0x64,
	0x72, 0x69, 0x76, 0x65, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x44, 0x72,
	...
	0x62, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x6d,
	0x6f, 0x64, 0x65, 0x6c, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_pbdriveroperator_models_proto_rawDescOnce sync.Once
	file_pbdriveroperator_models_proto_rawDescData = file_pbdriveroperator_models_proto_rawDesc
)

func file_pbdriveroperator_models_proto_rawDescGZIP() []byte {
	file_pbdriveroperator_models_proto_rawDescOnce.Do(func() {
		file_pbdriveroperator_models_proto_rawDescData = protoimpl.X.CompressGZIP(file_pbdriveroperator_models_proto_rawDescData)
	})
	return file_pbdriveroperator_models_proto_rawDescData
}
...
var file_pbdriveroperator_models_proto_goTypes = []any{
	...
	(pbdrivermodels.ErrorCode)(0),     // 6: io.clbs.openhes.pbdriver.ErrorCode
}
