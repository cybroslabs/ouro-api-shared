...
func (BulkStatusCode) EnumDescriptor() ([]byte, []int) {
	return file_pbdataproxy_models_proto_rawDescGZIP(), []int{0}
}
...
type BulkSpec struct {
	...
	Devices       []*pbtaskmastermodels.JobDevice `protobuf:"bytes,5,rep,name=devices,proto3" json:"devices,omitempty"`                                  // The list of devices in the bulk.
	Settings      *pbdrivermodels.JobSettings     `protobuf:"bytes,6,opt,name=settings,proto3" json:"settings,omitempty"`                                // The bulk-shared job settings.
	JobActions    []*pbdrivermodels.JobAction     `protobuf:"bytes,7,rep,name=job_actions,json=jobActions,proto3" json:"job_actions,omitempty"`          // The list actions to be executed.
...
func (*BulkSpec) Descriptor() ([]byte, []int) {
	return file_pbdataproxy_models_proto_rawDescGZIP(), []int{1}
}
...
func (*BulkStatus) Descriptor() ([]byte, []int) {
	return file_pbdataproxy_models_proto_rawDescGZIP(), []int{2}
}
...
type BulkJobStatus struct {
	...
	Status        *pbtaskmastermodels.JobStatus `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`            // The job status.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (*BulkJobStatus) Descriptor() ([]byte, []int) {
	return file_pbdataproxy_models_proto_rawDescGZIP(), []int{3}
}
...
func (*GetBulkResponse) Descriptor() ([]byte, []int) {
	return file_pbdataproxy_models_proto_rawDescGZIP(), []int{4}
}
...
func (*GetBulksReuqest) Descriptor() ([]byte, []int) {
	return file_pbdataproxy_models_proto_rawDescGZIP(), []int{5}
}
...
func (*GetBulksResponse) Descriptor() ([]byte, []int) {
	return file_pbdataproxy_models_proto_rawDescGZIP(), []int{6}
}
...
func (*GetBulkRequest) Descriptor() ([]byte, []int) {
	return file_pbdataproxy_models_proto_rawDescGZIP(), []int{7}
}
...
func (*GetJobStatusRequest) Descriptor() ([]byte, []int) {
	return file_pbdataproxy_models_proto_rawDescGZIP(), []int{8}
}
...
type GetJobStatusResponse struct {
	state         protoimpl.MessageState        `protogen:"open.v1"`
	Status        *pbtaskmastermodels.JobStatus `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"` // The status of the job
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (*GetJobStatusResponse) Descriptor() ([]byte, []int) {
	return file_pbdataproxy_models_proto_rawDescGZIP(), []int{9}
}
...
var file_pbdataproxy_models_proto_rawDesc = []byte{
	...
	0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x22, 0x9d, 0x03, 0x0a, 0x08, 0x42, 0x75, 0x6c, 0x6b,
	...
	0x62, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x24, 0x0a, 0x0b, 0x77, 0x65, 0x62, 0x68,
	0x6f, 0x6f, 0x6b, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52,
	0x0a, 0x77, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x55, 0x72, 0x6c, 0x88, 0x01, 0x01, 0x12, 0x17,
	0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x77, 0x65, 0x62, 0x68,
	0x6f, 0x6f, 0x6b, 0x5f, 0x75, 0x72, 0x6c, 0x22, 0x91, 0x01, 0x0a, 0x0a, 0x42, 0x75, 0x6c, 0x6b,
	...
	,
	...
	0x61, 0x74, 0x75, 0x73, 0x22, 0x8d, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x42, 0x75, 0x6c, 0x6b,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39, 0x0a, 0x04, 0x73, 0x70, 0x65, 0x63,
	...
	,
	...
	0x65, 0x74, 0x42, 0x75, 0x6c, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x05,
	0x62, 0x75, 0x6c, 0x6b, 0x73, 0x22, 0x29, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x42, 0x75, 0x6c, 0x6b,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x62, 0x75, 0x6c, 0x6b, 0x5f,
	...
	,
	...
	0x6f, 0x78, 0x79, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_pbdataproxy_models_proto_rawDescOnce sync.Once
	file_pbdataproxy_models_proto_rawDescData = file_pbdataproxy_models_proto_rawDesc
)

func file_pbdataproxy_models_proto_rawDescGZIP() []byte {
	file_pbdataproxy_models_proto_rawDescOnce.Do(func() {
		file_pbdataproxy_models_proto_rawDescData = protoimpl.X.CompressGZIP(file_pbdataproxy_models_proto_rawDescData)
	})
	return file_pbdataproxy_models_proto_rawDescData
}
...
func file_pbdataproxy_models_proto_init() {
	...
	file_pbdataproxy_models_proto_msgTypes[1].OneofWrappers = []any{}
	file_pbdataproxy_models_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
