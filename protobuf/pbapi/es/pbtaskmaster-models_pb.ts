...
import type { ActionData, ActionResultCode, ApplicationProtocol, AttributeValue, ConnectionInfo, ErrorCode, JobAction, JobErrorCode, JobSettings } from "./pbdriver-models_pb";
...
export const file_pbtaskmaster_models: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_empty, file_google_protobuf_timestamp, file_pbdriver_models]);
...
export type CacheGetResponse = Message<"io.clbs.openhes.pbtaskmaster.CacheGetResponse"> & {
  /**
   * The result of the cache get operation.
   *
 ...
 * API <-> Taskmaster request/response for system configuration
 *
 * @generated from message io.clbs.openhes.pbtaskmaster.SystemConfigResponse
 */
export type SystemConfigResponse = Message<"io.clbs.openhes.pbtaskmaster.SystemConfigResponse"> & {
  /**
   * The maximum number of replicas for the driver.
   *
   * @generated from field: io.clbs.openhes.pbtaskmaster.SystemConfig config = 1;
   */
  config?: SystemConfig;
   ...
   * The system status.
   *
   * @generated from field: io.clbs.openhes.pbtaskmaster.SystemConfigStatus status = 2;
   */
  status?: SystemConfigStatus;
};

/**
 * Describes the message io.clbs.openhes.pbtaskmaster.SystemConfigResponse.
 ...
 *
 * @generated from message io.clbs.openhes.pbtaskmaster.SystemConfigStatus
 */
export type SystemConfigStatus = Message<"io.clbs.openhes.pbtaskmaster.SystemConfigStatus"> & {
  /**
   * The length of the job queue.
   *
   * @generated from field: int64 queue_length = 1;
   */
  queueLength: bigint;
};

/**
 * Describes the message io.clbs.openhes.pbtaskmaster.SystemConfigStatus.
